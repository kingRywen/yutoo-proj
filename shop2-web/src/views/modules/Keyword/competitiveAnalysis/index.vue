<template>
  <main-layout
    ...
    url="keyword/taskKeywordCompeteList"
    ref="layout"
  ></main-layout>
</template>
<script>
      ...
      edits: [
        {
          ...
          fn: scope => {
            vm.$router.push({
              path: '/keyword/competitiveAnalysis/detail',
        ...
        },
        {
          ...
          fn: scope => {
            ...
            this.showConfirmGlobal(
              'keyword/taskKeywordCompeteReCrawl',
              params,
              '重新抓取'
            )
          }
        },
        {
          ...
          fn: scope => {
            let params = { taskIds: [scope.row.taskId], ...vm.outerParams }
            this.showConfirmGlobal(
              'keyword/taskKeywordCompeteRemove',
              params,
              '删除'
            )
          }
  ...
  methods: {
    ...
    showDialog(id) {
      this.showDialogGlobal(
        `关键词列表`,
        '100%',
        { id: id, url: 'keyword/taskKeywordCompeteInfo' },
