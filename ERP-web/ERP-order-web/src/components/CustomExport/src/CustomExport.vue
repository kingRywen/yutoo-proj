          ...
          <el-table :data="myData">
            ...
            <el-table-column label="操作">
              <template slot-scope="scope">
                ...
                <el-button type="text" @click="myDel(scope.row.globalTemplateId)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-col>
  ...
  methods: {
    ...
    myDel(globalTemplateId) {
      this.$confirm('此操作将永久删除该模板, 是否继续?', '提示', {
        ...
        .then(() => {
          this.$api[`order/globalTemplateRemove`]({
            globalTemplateIds: Array.of(globalTemplateId)
          })
            .then(data => {
