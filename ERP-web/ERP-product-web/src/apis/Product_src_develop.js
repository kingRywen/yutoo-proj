...
// 销售提报-批量删除
const PRODUCTSRCDEVELOP_BATCHREMOVE = {
  method: 'post',
  url: "/ProductSrcDevelop/batchRemove",
}
...
// 平台采集-添加(没做)
const PRODUCTSRCCOLLECT_SAVE = {
  method: 'post',
  url: "/ProductSrcCollect/save",
}

// 平台采集-添加(没做)
const PRODUCTSRCCOLLECT_UPDATE = {
  method: 'post',
  url: "/ProductSrcCollect/update",
}

// 平台采集-添加(没做)
const PRODUCTSRCCOLLECT_REMOVE = {
  method: 'post',
  url: "/ProductSrcCollect/remove",
}
...
module.exports = {
  ...
  PLATFORM_LIST,
  PRODUCTSRCCOLLECT_UPDATE,
  PRODUCTSRCCOLLECT_REMOVE,
  PRODUCTSRCCOLLECT_SAVE,
  PRODSRCSUPPLIER_REMOVE,
  PRODUCTSRCDEVELOP_BATCHREMOVE,
  SYS_USER_LISTALL,
