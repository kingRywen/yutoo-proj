...
// 【平台】获取所有的激活平台
const PLATFORM_LIST_ALL_ACTIVATE_PLATFORM = {
  method: 'post',
  url: '/platform/list/all/activate/platform'
}
...
// "countryIds", "搜索国家"        大洲-国家 树形列表
const PRODUCT_PLATFORM_AREA_LIST = {
  method: 'post',
  url: '/product/platform/area/list'
}
...
// 批量搜索SKU
const PRODUCT_LIST_SKU = {
  method: 'post',
  url: '/product/list/sku'
}

// 批量搜索SKU
const PRODUCT_BATCH_UPDATE_DOWNLOAD = {
  method: 'post',
  url: '/product/batch/update/download'
}

// 批量搜索SKU
const PRODUCT_DEFAULT_SUPPLIER_PRICE = {
  method: 'post',
  url: '/product/default/supplier/price'
}

// sku获取
const PRODUCT_PARENT_SKU_LIST = {
  method: 'post',
  url: '/product/parent/sku/list'
}

// sku获取
const PRODUCT_VARIANT_REMOVE_CHECK = {
  method: 'post',
  url: '/product/variant/remove/check'
}

// sku获取
const PRODUCT_TYPE_GET = {
  method: 'post',
  url: '/product/type/get'
}

// 获取平台
const PRODUCT_PLATFORM_SIGN_LIST = {
  method: 'post',
  url: '/product/platform/sign/list'
}

// 获取平台
const CategoryPlatform = {
  method: 'post',
  url: '/CategoryPlatform/searchPath'
}



// 仓库产品作废还原
const PRODUCT_INVALID_BACK = {
  method: 'post',
  url: '/product/invalid/back'
}

// 修改图片
const PRODUCT_IMG_MASTER_UPDATE = {
  method: 'post',
  url: '/product/img/master/update'
}

// 修改报关价
const PRODUCT_ENTRY_PRICE_PERCENT_SAVE = {
  method: 'post',
  url: '/product/entry/price/percent/save'
}
...
// 审核不通过 的原因
const PRODUCT_PLT_LANGUAGE_AUDIT_REASON_LIST = {
  method: 'post',
  url: '/product/plt/language/audit/reason/list'
}

// 打印生产加工单条码
const PRODUCT_DOWNLOAD_PROCESS_CODE = {
  method: 'post',
  url: '/product/download/process/code'
}

// 打印生产加工单条码
const storeGetAllStore = {
  method: 'post',
  url: '/store/getAllStore'
}

// 打印生产加工单条码
const productBaseRolesGet = {
  method: 'post',
  url: '/product/base/roles/get'
}
...
module.exports = {
  ...
  productBaseRolesGet,
  GET_PRODUCT_ACC_V,
  PRODUCT_PLT_LANGUAGE_AUDIT_REASON_LIST,
  PRODUCT_PLT_AUDIT_IMG_INFO,
  PLATFORM_LIST_ALL_ACTIVATE_PLATFORM,
  PRODUCT_IMG_MASTER_UPDATE,
  PRODUCT_ENTRY_PRICE_PERCENT_SAVE,
  PRODUCT_INVALID_BACK,
  CategoryPlatform,
  PRODUCT_DOWNLOAD_PROCESS_CODE,
  PRODUCT_PLATFORM_SIGN_LIST,
  PRODUCT_TYPE_GET,
  PRODUCT_VARIANT_PAGE,
  PRODUCT_VARIANT_REMOVE_CHECK,
  PRODUCT_DEFAULT_SUPPLIER_PRICE,
  PRODUCT_PARENT_SKU_LIST,
  PRODUCT_KEY_WORD_VERIFY_1,
  PRODUCT_BATCH_UPDATE_DOWNLOAD,
