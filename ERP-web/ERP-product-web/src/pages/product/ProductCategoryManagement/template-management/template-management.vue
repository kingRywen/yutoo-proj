...
export default {
    data() {
        return {
            ...
            activePlatform: localStorage.getItem('cur_category_platform')
                ? localStorage.getItem('cur_category_platform')
                : 'Amazon',
            siteId: null,
            loading: true
        };
    ...
    methods: {
        ...
        //切换平台
        handlePlatform(tab) {
            localStorage.setItem('cur_category_platform', tab.name);
