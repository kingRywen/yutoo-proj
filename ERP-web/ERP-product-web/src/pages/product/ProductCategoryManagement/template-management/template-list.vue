<template lang="html">
        ...
        <div class="selectbox">
            <el-form :inline="true" class="demo-form-inline" size="small">
                <el-form-item label="站点：">
                    <el-select v-model="selectForm.siteKey" @change="siteChange" clearable size="small">
                ...
                <el-form-item label="类目：">                   
                     <SyncCascader
                        ...
                        :props = "categoryProps"                        
                        :load="selectForm.siteKey?loadTree:loadTree1"
                        size="small"
                        @change="treeChange"
                        clearable
                        :key="selectForm.siteKey" 
                        style="width:217px;"/>
                </el-form-item>
                <el-form-item label="模板名称：">
                    <el-input v-model.trim='selectForm.name' clearable size="small" />
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" icon="el-icon-search" size="small" @click="onSelectSubmit()">搜 索</el-button>
                </el-form-item>
            </el-form>
        </div>
        <!--  -->
        <!-- <p class="ml0">
            <el-button type="info" disabled size="small" @click="fn" >导入模板</el-button>
            <el-button type="info" disabled size="small" @click="fn">批量导入模板</el-button>
        </p> -->
        <!--  -->
        <el-table
            v-loading="loading"
            ...
            height="610px"
            class="tampTable ml0" :data="tempList"   style="width: 100%" border>
            <el-table-column  prop="templateName"  label="模板名称"  width="224" align="center"/>
            <el-table-column  label="站点"  width="150" align="center">
                <template slot-scope="scope">
                    <img :src="scope.row.siteImg" alt="" width="30">
                    <span style="vertical-align: super;">{{scope.row.siteName}}</span>
                </template>
            </el-table-column>
            <el-table-column  prop="platformCategoryName" label="类别" align="left"></el-table-column>
    ...
    <el-button type="text">
        <router-link :to="{ name: 'uploading', params: {operate:true,catePltTemplateId:scope.row.catePltTemplateId,banner:scope.row.banner,platformId:scope.row.platformId, siteId: scope.row.siteId} }" tag="span">修改</router-link>
    </el-button>
</template>
            </el-table-column>
        </el-table>
