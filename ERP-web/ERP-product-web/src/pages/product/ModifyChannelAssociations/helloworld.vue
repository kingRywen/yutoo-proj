    ...
    <div class="toSellStrategy">
        ...
        <div class="toSellStrategy-content">
            ...
            <el-form :inline="true" size="small">
                ...
                <div class="mar10">
                    <el-form-item>
                      <el-button type="primary" @click="add('新增规则')">新 增 规 则</el-button>
                    </el-form-item>
                    <el-form-item>
                      <el-button type="primary" @click="alldel">批 量 删 除</el-button>
                    </el-form-item>
                </div>
            </el-form>
            <!--  -->
    ...
    data() {
        return {
            ...
            columns:[
                ...
                { label:"规则有效期", width:"" ,value:"validTimeEnd" },
                { label:"是否激活", width:"" ,value:"activateFlag" ,boole:true},
                { label:"添加时间", width:"" ,value:"createTime" },
            ...
            dialog:{
                ...
                loading:false,
                columns:[
                    { label:"星期一", startvalue:"mondayStartTime",endvalue:"mondayEndTime"},
                    { label:"星期二", startvalue:"tuesdayStartTime",endvalue:"tuesdayEndTime"},
                    { label:"星期三", startvalue:"wednesdayStartTime",endvalue:"wednesdayEndTime"},
                    { label:"星期四", startvalue:"thursdayStartTime",endvalue:"thursdayEndTime"},
                    { label:"星期五", startvalue:"fridayStartTime",endvalue:"fridayEndTime"},
                    { label:"星期六", startvalue:"saturdayStartTime",endvalue:"saturdayEndTime"},
                    { label:"星期日", startvalue:"sundayStartTime",endvalue:"sundayEndTime"},
                ],
                resetVisible:false,
    ...
    methods: {
        ...
        edit(title,sellRuleId){
            ...
            this.http('sell/rule/info',{sellRuleId},data=>{
                ...
                this.dialogForm.time = [ruleInfo.validTimeStart,ruleInfo.validTimeEnd];
                this.dialogForm.timezone = ruleInfo.timezone;
                this.dialogForm.remark = ruleInfo.remark;
                this.dialogForm.activateFlag = ruleInfo.activateFlag?true:false;
                if(ruleInfo.ruleDetails instanceof Array && ruleInfo.ruleDetails.length){
                    this.dialogForm.ruleDetails = []
                    ruleInfo.ruleDetails.forEach((item,index)=>{
                        this.dialogForm.ruleDetails.push(new CreateTimeObj(index+1))
                        for(let k in this.dialogForm.ruleDetails[index]){
                            for(let j in item){
                                if(k==j){
                                    this.dialogForm.ruleDetails[index][k] = item[j]
        ...
        addTrackingTime(){
            let length = this.dialogForm.ruleDetails.length;
            let id = length ? (this.dialogForm.ruleDetails[length-1]['id']  + 1) : 1
