<template lang="html">
    <div class="regulation_list">
        <el-table ref="multipleTable" height="580px" :data="data" border tooltip-effect="dark" style="width: 100%" @selection-change="userSelect">
            ...
            <el-table-column prop="objectName" label="店铺名称" width="180" v-if="ruleType"></el-table-column>
            <el-table-column label="规则公式">
                <template slot-scope="scope">
    <span v-for="item in scope.row.skuRuleModel" style="margin-right:5px;">
        {{item.name}} {{item.content}}
        <span v-if="item.key!==8 && item.auto">位数</span>
    </span>
</template>
            </el-table-column>
            ...
            <el-table-column prop="createTime" label="规则日志" width="180"></el-table-column>
