    ...
    methods: {
        ...
        submit(params) {
            ...
            if (this.title.indexOf('编辑') != -1) {
                this.send(
                    ...
                    {
                        ...params,
                        skuRuleId: this.skuRuleId,
                        merchantId: this.ruleInfo.merchantId,
                        createId: this.ruleInfo.createId
                    },
                    msg => {
                        this.$message({
                            message: msg,
        ...
        handleCurrentChange(val) {
            ...
            if (this.selectInfo['activateFlag'] != '') {
                params = {
                    ...params,
                    activateFlag: this.selectInfo['activateFlag']
                };
            }
        ...
        getShopList() {
            return getData('store/list', {
                ...
                if (res.data.code == 0) {
                    this.shopList = res.data.rows.rows;
                } else {
                    this.$message.error(res.data.msg);
                }
            });
