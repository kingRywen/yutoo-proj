  ...
  <div>
    ...
    >
      ...
      <template v-if="!isPurchase">
        <el-tab-pane v-for="(val, key) in variantEntityList" :label="val.skuCustom" :key="val.sku" :name="val.sku" lazy>
          <uploadImg
            ref="upload"
            v-if="name === val.sku"
            :variantFiles="imgs"
      ...
      <template v-else-if="$attrs.allInfo.imgTabField[0] != null">
        <el-tab-pane
          v-for="(val, key) in variantList"
          :label="val.variant.skuCustom"
          :key="val.variant.sku"
        ...
        >
          <uploadImg
            ...
            :product-id="val.variant.productId"
            :show="$attrs.show"
            :base-save="true"
          ></uploadImg>
        </el-tab-pane>
