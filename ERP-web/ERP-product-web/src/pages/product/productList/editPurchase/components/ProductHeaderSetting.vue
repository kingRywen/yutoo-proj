      ...
      <el-tab-pane label="海运" name="海运" style="height:100%;overflow: auto" lazy>
        ...
        >
          <template slot="td" slot-scope="props">
            <div
              v-if="props.column.field=='freightPrice'"
            >{{props.content != null ? props.content + props.item.freightPriceUnit : '-' }}</div>
            <div v-else-if="props.column.field=='nw'">{{props.content}}(g)</div>
            ...
            <div v-else-if="props.column.field=='edit'">
              <v-button @click="edit(props)" :disabled="$attrs.show">编辑</v-button>
              <v-button @click="del(props)" :disabled="$attrs.show">删除</v-button>
            </div>
      ...
      <el-tab-pane label="空运" name="空运" style="height:100%;overflow: auto" lazy>
        ...
        >
          <template slot="td" slot-scope="props">
            ...
            <div v-else-if="props.column.field=='productWeight'">{{props.content}}(g)</div>
            <div v-else-if="props.column.field=='entryPrice'">{{props.content}}{{props.item.entryPriceUnit}}</div>
            <div v-else-if="props.column.field=='productVolume'">
              {{props.item.singleHigh * props.item.singleLong * props.item.singleWide}}(cm
              <sup>3</sup>)
