        ...
        <div style="padding:10px;">
            <div class="select">
                ...
                <div class="select_item">
                    ...
                    <el-date-picker v-model="selectInfo.timeArr" type="datetimerange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd HH:mm:ss" align="right" size="medium"></el-date-picker>
                </div>
                <div class="select_item">
                ...
                <div class="select_item">
                    <el-button type="primary" @click="select()" icon="el-icon-search" size="medium">搜 索</el-button>
                </div>
            </div>
            <div class="operation_btn">
                <el-button type="primary" @click="addAndDmend(true)" icon="el-icon-plus" size="small">添加</el-button>
                <el-button type="danger" :disabled="!checkedArr.length" @click="deletePortion" size="small" icon="el-icon-delete">批量删除</el-button>
            </div>
            ...
            <el-dialog title="类别管理" :visible.sync="classDialog" width="600px">
                <div class="select-class">
                    <span>类别名称：</span>
                    <span>
                        <el-input size="small" v-model.trim="selectTypeinput" clearable/>
                    </span>
                ...
                <el-table :data="typeList" border style="width: 100%;margin-top:10px;" height="335px">
                    ...
                    <el-table-column label="操作" align="center">
                        <template slot-scope="scope">
                            ...
                            <el-button type="text" size="small" @click="delType(scope.row.sensitiveKeywordLibraryId)" v-if="scope.row.defaultFlag?false:true">删 除</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </el-dialog>
    ...
    methods: {
        ...
        delType(sensitiveKeywordLibraryId) {
            this.$confirm('确定删除吗?', '提示', {
                ...
                this.handleType('sensitive/keyword/library/remove', {
                    sensitiveKeywordLibraryId: Array.of(
                        sensitiveKeywordLibraryId
                    )
                });
            });
                ...
                if (valid) {
                    ...
                    if (this.classTypeTitle == '添加类别') {
                        ...
                        this.handleType('sensitive/keyword/library/update', {
                            name,
                            sensitiveKeywordLibraryId: this
                                .sensitiveKeywordLibraryId
                        });
                    }
                } else {
        ...
        handleSizeChange(val) {
            ...
            if (
                this.selectInfo.timeArr != null &&
                this.selectInfo.timeArr.length
            ) {
                params = {
                    ...params,
