          ...
          <div>
            <v-form direction="horizontal" :model="ruleForm" ref="ruleform">
              <v-row>
                ...
                <v-col span="24">
                  <v-form-item label="原因" :label-col="labelCol" :wrapper-col="wrapperCol" :required="ruleForm.auditStatus === 3" :rules="[{required:ruleForm.auditStatus === 3 ? true : false, message: '请填写不通过的原因'}]" prop="auditReason">
