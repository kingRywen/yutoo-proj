...
export default {
  ...
  created() {
    this.platform = _storage._get('session', 'platCurrentPlatform')
  },
  methods: {
    up(props) {
    ...
    exportExcel() {
      ...
      if (type === 1) {
        ...
        let fieldList
        // if (this.platType === 1) {
        //   fieldList = this.tableData.map(el => el.id)
        // }
        // if (this.platType === 2) {
