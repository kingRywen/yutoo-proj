                ...
                <el-form :inline="inline" :model="searchForm" class="searchForm" ref="form">
                    <template v-for="(item,index) in searchList">
                        <el-form-item :label="item.label || null" :key='index'>
                            ...
                            <!-- 分类按钮选择 -->
                            <tree-btn :styles="item.style || ''" :size="item.size || 'small'" :classifyType="item.classifyType" :showCheckbox="item.showCheckbox || false" v-if="item.type === 'treeBtn'" :text="item.text" @close="getCheckedNodes"></tree-btn>
                            <!-- 文本域 -->
                            <el-input
