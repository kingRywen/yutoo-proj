    ...
    <el-form class="search-top-form" :model="writeData" label-width="170px">
      <el-col :span="17">
        ...
        <el-row v-if="concat">
          <el-row>
            <el-col :span="4">
              <el-select size="small" placeholder v-model="selectOrder">
                <el-option label="平台订单号" value="orderNumPlatform"></el-option>
                <el-option label="系统订单号" value="orderNumSystem"></el-option>
              </el-select>
            </el-col>
            <el-col :span="12" style="margin: 0 10px">
              <el-input size="small" v-model="orderNumValue"></el-input>
            </el-col>
            <el-col :span="3">
              <el-button size="small" type="primary" @click="handleLoad">加载信息</el-button>
            </el-col>
          </el-row>
          <el-form-item size="small" label="订单来源：" class="martop">
            <el-select placeholder="选择来源店铺" v-model="writeData.storeId">
...
export default {
  ...
  watch: {
    ...
    orderNumValue(val) {
      if (val) {
        this.writeData[this.selectOrder] = val
      }
    },
    writeForm: {
      immediate: true,
