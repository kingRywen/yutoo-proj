        ...
        <el-table-column label="操作" align="center" width="90px">
          <template slot-scope="scope">
            <el-tooltip effect="dark" content="查看详情" placement="top" :open-delay="500">
              <i @click="handleCheck(scope.row)" class="iconfont1">&#xe7e3;</i>
            </el-tooltip>
            <el-tooltip effect="dark" content="操作日志" placement="top" :open-delay="500">
              <i @click="handleOperatorLog(scope.row)" class="iconfont1">&#xe63b;</i>
            </el-tooltip>
            <el-tooltip effect="dark" v-if="scope.row.state != 1" content="处理" placement="top" :open-delay="500">
              <i class="iconfont1" @click="handleBargain(scope.row)">&#xe638;</i>
            </el-tooltip>
          </template>
        </el-table-column>
      </template>
