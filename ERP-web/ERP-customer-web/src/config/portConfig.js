/* eslint-disable */
import { guo, deng, zhang } from "./ipConfig";
/* eslint-disable */
export default {
  // 开发环境
  'dev': {
  ...
  'prod':{
    ...
    PERMS_URL: 'http://localhost:8082',
    PRODUCT_URL: 'http://localhost:8083',
    PROCUREMENT_URL: 'http://localhost:8085',
    ORDER_URL: 'http://localhost:8086',
    EMAIL_URL: 'http://localhost:8087',
    WAREHOUSE_URL: 'http://localhost:8088',
  },
  // 沙盒环境（勿改）
  'test_env': {
