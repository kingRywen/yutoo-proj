...
export default [
  ...
  {
    name: 'inventoryplandelete',
    method: 'POST',
    desc: '盘点删除',
    path: '/wm/inventory/plan/delete',
    mock: true,
    params: {}
  },
  {
  ...
  {
    name: 'wminventoryplansavelocations',
    method: 'POST',
    desc: '保存库位',
    path: '/wm/inventory/plan/save/locations',
    params: {}
  },
  {
    name: 'wminventoryplanlocations',
    method: 'POST',
    desc: '获取库位',
    path: '/wm/inventory/plan/list/locations',
    params: {}
  },
  //移库管理
  {
  ...
  },
  {
    ...
    method: 'POST',
    desc: '查询某个仓库中的产品',
    path: '/wm/move/plan/list/warehouse/product',
    params: {}
  },
  {
    name: 'movePlanChooseWarehouse',
    method: 'POST',
    desc: '选择仓库产品',
    path: '/wm/move/plan/choose/warehouse/product',
    params: {}
  },
  {
  ...
  //订单包裹发货计划
  {
    name: 'packagesetsignfor',
    method: 'POST',
    desc: '【订单包裹单】设置已签收',
    path: '/wm/package/set/sign/for',
    params: {}
  },
  {
    name: 'packagecancelsignfor',
    method: 'POST',
    desc: '【订单包裹单】撤销已签收',
    path: '/wm/package/cancel/sign/for',
    params: {}
  },
  {
  ...
  },
  {
    ...
    method: 'POST',
    desc: '三种管理人员',
    path: '/WmWarehouseStaff/user/listAll',
    params: {}
  },
  {
  ...
  {
    name: 'wmRecommendCreateMovePlan',
    method: 'POST',
    desc: '生成移库计划',
    path: '/wm/recommend/create/move/plan',
    params: {}
  },
  {
    name: 'wmRecommendIgnore',
    method: 'POST',
    desc: '生成移库计划设置忽略',
    path: '/wm/recommend/ignore',
    params: {}
  },
  {
    name: 'wmMovePlanLocation',
    method: 'POST',
    desc: '获取推荐库位',
    path: '/wm/move/plan/get/recommend/location',
    params: {}
  },
  {
    name: 'wmPackageBoxCode',
    method: 'POST',
    desc: '获取箱子条码信息',
    path: '/wm/package/print/box/code',
    params: {}
  }
]
