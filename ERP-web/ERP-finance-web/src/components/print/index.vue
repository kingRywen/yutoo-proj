<template>
  <div class="print" style="width: 700px" v-loading="loading" :element-loading-text="loadingText">
    ...
    <div v-if="$route.query.title==='打印成品加工单'">
      ...
      <table :class="tableClass" v-for="(item, index) in data" :key="index">
        <tbody>
          ...
          <tr v-for="(mate, i) in item.materials" :key="mate.id">
    ...
    getData() {
      ...
      switch (title) {
        ...
        case '打印合同':
          ...
          params = {
            purchaseOrderManageId: +purchaseIds[0],
