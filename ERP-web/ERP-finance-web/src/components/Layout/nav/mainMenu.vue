<template>
    <!-- 主菜单 -->
    <div>
        <el-menu class="menu-hearder" :default-active="activeIndex" mode="horizontal" @select="handleSelect" background-color="#404040" text-color="#fff" active-text-color="#ffd04b">
...
export default {
    ...
    data() {
        return {
            activeIndex:
                loginRedirect +
                'erp-finance/#/finance/dailyOperation/refunds'
        };
    },
    // watch: {
    //   $route(to, from) {
