export default [
  {
    ...
    method: 'POST',
    desc: '获取采购点列表',
    path: '/supplier/purchase/address/getAddressList',
    mockPath: '/',
    params: {}
  },

  {
    ...
    method: 'POST',
    desc: '获取账期类型列表',
    path: '/supplier/purchase/period/getPeriodList',
    mockPath: '/',
    params: {}
  },
   ...
   */
  {
    ...
    method: 'POST',
    desc: '质检管理-根据产品条码查询信息',
    path: '/purchase/QC/getDetailByCode',
    mockPath: '/purchase/QC/getDetailByCode',
    params: {}
  },
  {
    name: 'getIssueClassify',
    method: 'POST',
    desc: '质检管理-获取质量问题归类',
    path: '/purchase/QC/getIssueClassify',
    mockPath: '/purchase/QC/getIssueClassify',
    params: {}
  },
  {
    name: 'confirmQC',
    ...
    desc: '质检管理-确认质检',
    path: '/purchase/QC/confirmQC',
    mockPath: '/purchase/QC/confirmQC',
    params: {}
  }
]
