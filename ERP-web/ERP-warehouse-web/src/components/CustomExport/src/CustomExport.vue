        ...
        <el-col :span="24">
          ...
          <el-table :data="myData">
            ...
            <el-table-column label="操作">
              <template slot-scope="scope">
                <el-button style="padding: 0; margin-right:4px" type="text" @click="mySelect(scope.row)">选择</el-button>
                <el-button style="padding: 0; margin-right:4px" type="text" @click="myDel(scope.row[fieldId])">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-col>
  ...
  methods: {
    ...
    save(type, figureFlag) {
      ...
      if (type === 1) {
        ...
        return savePromise(this.selectFields, this.tempName)
          .then(data => {
        ...
        return excelPromise(this.selectFields, figureFlag)
          .then(data => {
            this.$emit('exSuccess', data)
