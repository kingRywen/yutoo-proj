<template>
    <div class="contentform">
        <el-form :model="ruleForm" ref="ruleForm" label-width="110px" size="small" @validate="validate">
            <el-form-item label="选择仓库：" prop="wmWarehouseId" :rules="[
                { required: true, message: '请选择仓库', trigger: 'change' },          
                ]">
                <el-select v-model="ruleForm.wmWarehouseId" style="width:100%;">
                    <el-option :label="i.label" :value="i.value" :key="i.label" v-for="i in $store.state.daily.warehouseList"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="篮子位置编码：" prop="seatModels" :rules="[
                ...
                <el-row>
                    <el-col :span="editBoole?18:24" v-if="!isBatch">
                        <el-input v-model.trim="ruleForm.seatModels"></el-input>
                    </el-col>
                    <el-col :span="6">
            ...
            <el-collapse-transition>
                <div v-if="isBatch">
                    <div class="formitem">
                        <el-form-item class="marleft1" label="批量添加：" prop="prefix" :rules="[
                            { required: true, validator: prefix, trigger: 'blur' },
                        ]">
                            <el-row>
                                <el-col :span="6" class="textCenter">前缀</el-col>
                                <el-col :span="18">
                                    <el-input v-model="ruleForm.prefix" placeholder="中英文/数字"></el-input>
                                </el-col>
                            </el-row>
                        </el-form-item>
                        <!--  -->
              ...
              { required: true,  validator: maxRules, trigger: 'blur' },
            ]">
                            <el-row>
            ...
            <el-form-item label="对应篮子规格：" prop="wmPickingBasketNormId" :rules="[
        ...
        <!--  -->
        <el-dialog title="拣货篮规格管理" :visible.sync="visible" width="1100px" :append-to-body="true" @close="close">
...
<script>
/* eslint-disable */
import specifications from '../pickingBasket/specifications';
...
export default {
        ...
        return {
            ...
            minRules: (rule, val, callback) => {
                ...
                if (reg.test(value)) {
                    ...
                    callback(new Error('须为1-100的整数值'));
                }
            },
    ...
    methods: {
        ...
        edit(wmPickingBasketSeatId) {
            ...
            this.$api['warehouse/WmPickingBasketSeatInfo']({
                ...
                this.ruleForm.seatModels = seatModel;
        ...
        changeIsBatch() {
            ...
            setTimeout(() => {
                if (this.isBatch) {
                    this.$refs.ruleForm.validateField('seatModels');
