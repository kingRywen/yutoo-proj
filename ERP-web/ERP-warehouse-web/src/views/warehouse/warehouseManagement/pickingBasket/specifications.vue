        ...
        return {
            tableConfig: [
                ...
                },
                {
                    ...
                    render(h, scope) {
                        return <p class="textOverflow">{scope.row.normDesc}</p>;
                    }
                },
                {
                    value: 'activatedFlag',
                            ...
                            return (
                                <span
                                    onClick={() => {
                                        let params = {
                                            ...scope.row,
                                            activatedFlag: scope.row
                                                .activatedFlag
                                                ? 0
                                                : 1
                                        };
                                        vm.$api[
                                            'warehouse/WmPickingBasketNormUpdate'
                                        ](params)
                                            .then(() => {
            ...
            btnConfig: [
                ...
                },
                {
                    name: '批 量 删 除',
                    disabled: () => {
                        return this.wmPickingBasketNormIds.length
                            ? false
                            : true;
                    },
                    type: 'danger',
    ...
    methods: {
        ...
        checkedDel(params) {
            this.$confirm('此操作将永久删除篮子规格, 是否继续?', '提示', {
                ...
                .then(() => {
                    this.$api['warehouse/WmPickingBasketNormDelete'](
                        params
                    ).then(res => {
