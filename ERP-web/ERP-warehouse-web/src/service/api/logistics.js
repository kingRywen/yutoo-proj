...
export default [
  ...
  {
    name: 'transportationTypeList',
    method: 'POST',
    desc: '根据运输类型获取运输方运输方式',
    path: '/logistic/transportation/type/list ',
    mockPath: '/logistic/transportation/type/list ',
    showSuccess: false,
    mock: false,
    params: {}
  },
   ...
   */
  {
    name: 'WmWarehouseStaffPage',
    method: 'POST',
    desc: '人员管理页面-分页查询(分页)',
    path: '/WmWarehouseStaff/page',
    mockPath: '/WmWarehouseStaff/page',
    showSuccess: false,
    mock: false,
    params: {}
  },
  {
    name: 'WmWarehouseStaffList',
    method: 'POST',
    desc: '人员管理页面-三种管理人员 下拉列表',
    path: '/WmWarehouseStaff/user/list',
    mockPath: '/WmWarehouseStaff/user/list',
    showSuccess: false,
    mock: false,
    params: {}
  },
  {
    name: 'WmWarehouseStaffSave',
    method: 'POST',
    desc: '人员管理页面-新增 编辑保存',
    path: '/WmWarehouseStaff/save',
    mockPath: '/WmWarehouseStaff/save',
    showSuccess: false,
    mock: false,
    params: {}
  },
  {
    name: 'WmWarehouseStaffGet',
    method: 'POST',
    desc: '人员管理页面-获取数据',
    path: '/WmWarehouseStaff/get',
    mockPath: '/WmWarehouseStaff/get',
    showSuccess: false,
    mock: false,
    params: {}
  },
  {
    name: 'WmWarehouseStaffRemove',
    method: 'POST',
    desc: '人员管理页面-批量删除',
    path: '/WmWarehouseStaff/remove',
    mockPath: '/WmWarehouseStaff/remove',
    showSuccess: false,
    mock: false,
    params: {}
  },
  {
    name: 'WmWarehouseGlobalPage',
    method: 'POST',
    desc: '人员管理页面-库位列表',
    path: '/WmLocation/list/page',
    mockPath: '/WmLocation/list/page',
    showSuccess: false,
    mock: false,
    params: {}
  },
  {
    name: 'WmWarehouseActiveUpdate',
    method: 'POST',
    desc: '人员管理页面-激活切换',
    path: '/WmWarehouseStaff/active/update',
    mockPath: '/WmWarehouseStaff/active/update',
    showSuccess: false,
    mock: false,
    params: {}
  },
  {
    name: 'WmWarehouseBatchAdd',
    method: 'POST',
    desc: '人员管理页面-库位添加保存',
    path: '/WmWarehouseStaff/location/batch/add',
    mockPath: '/WmWarehouseStaff/location/batch/add',
    showSuccess: false,
    mock: false,
    params: {}
  },
  {
    name: 'WmWarehouseBatchRemove',
    method: 'POST',
    desc: '人员管理页面-库位删除',
    path: '/WmWarehouseStaff/location/batch/remove',
    mockPath: '/WmWarehouseStaff/location/batch/remove',
    showSuccess: false,
    mock: false,
    params: {}
  },
  {
    name: 'WmWarehouseGlobalLists',
    method: 'POST',
    desc: '人员管理页面-仓库列表',
