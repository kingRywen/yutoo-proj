export default [
  ...
  {
    name: 'wmInventoryListChilds',
    method: 'POST',
    desc: '搜索所有仓库库存列表（变体）',
    path: '/WmInventory/list/childs',
    singleLoading: true,
    params: {}
  },
  {
    name: 'wmRepertoryStockLog',
    method: 'POST',
    desc: '日志',
    path: '/wm/repertory/stock/log',
    singleLoading: true,
    params: {}
  },
  {
  ...
  {
    name: 'wmWarehouseInfo',
    method: 'POST',
    desc: '获取仓库信息',
    // showSuccess: true,
    path: '/WmWarehouse/info',
    params: {}
  },
  {
  ...
  },
  {
    ...
    desc: '批量修改分区',
    showSuccess: true,
    path: '/WmWarehouseDivision/update',
    params: {}
  },
  {
  ...
  {
    name: 'wmInventoryEarlyWarningFind',
    method: 'POST',
    // showSuccess: true,
    desc: '全局产品预警库存设置(获取)',
    path: '/WmInventory/early/warning/find',
    params: {}
  },
  {
  ...
  {
    name: 'wmInventoryPendingPlatform',
    method: 'POST',
    desc: '仓库产品待收库存查询（平台仓）',
    path: '/WmInventory/pending/platform',
    params: {}
  },
  {
    name: 'wmInventoryPendingOverseas',
    method: 'POST',
    desc: '仓库产品待收库存查询（海外仓）',
    path: '/WmInventory/pending/overseas',
    params: {}
  },
  {
    name: 'wmInventoryPendingOverseasReturn',
    method: 'POST',
    desc: '仓库产品待收库存查询（海外仓:退货）',
    path: '/WmInventory/pending/overseas/return',
    params: {}
  },
  {
    name: 'wmInventoryPendingLocalReturn',
    method: 'POST',
    desc: '仓库产品待收库存查询（本地仓：退货）',
    path: '/WmInventory/pending/local/return',
    params: {}
  },
  {
    name: 'wmInventoryPendingPlatformReturn',
    method: 'POST',
    desc: '仓库产品待收库存查询（平台仓:退货）',
    path: '/WmInventory/pending/platform/return',
    params: {}
  },
  {
   ...
   */
  {
    name: 'wmPackageExportGetSystemTemplate',
    method: 'POST',
    desc: '【订单包裹单】获取系统模板',
    path: '/wm/package/export/getSystemTemplate',
    singleLoading: true,
    params: {}
  },
  {
    name: 'wmPackageExport',
    method: 'POST',
    desc: '【订单包裹单】导出',
    path: '/wm/package/export',
    params: {}
  },
  {
    name: 'wmPackageExportInfo',
    method: 'POST',
    desc: '【订单包裹单】查询模板，就是那个选中',
    singleLoading: true,
    path: '/wm/package/export/info',
    params: {}
  },
  {
    name: 'wmPackageExportRemove',
    method: 'POST',
    desc: '【订单包裹单】删除我的模板',
    path: '/wm/package/export/remove',
    params: {}
  },
  {
    name: 'wmPackageExportList',
    method: 'POST',
    desc: '【订单包裹单】查询我的模板列表',
    singleLoading: true,
    path: '/wm/package/export/list',
    params: {}
  },
  {
    name: 'wmPackageExportSave',
    method: 'POST',
    desc: '【订单包裹单】保存导出模板',
    path: '/wm/package/export/save',
    showSuccess: true,
    singleLoading: true,
    params: {}
  },
  {
    name: 'wmPackageColumnsList',
    method: 'POST',
