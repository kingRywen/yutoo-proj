<template>
    <div class="box">
        <div class="user-info_add-btn">
            <div class="user-info">{{merchantName}} 已购买产品</div>
            <el-button @click="showDialog(null,'ruleForm','add')" type="primary" size="mini">添加产品</el-button>
        </div>
...
export default {
  data() {
    ...
    created() {
      ...
      let merchantId =routeQuery.merchantId
      this.listQuery.merchantId =Number(merchantId)
