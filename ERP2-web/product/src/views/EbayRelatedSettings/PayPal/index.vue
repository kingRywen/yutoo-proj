<template>
    <div>
        <MainLayout
            ...
            ref="layout"
            url="product/PrConfigPaypalAccountEbayList"
            ...
            edits:[
                {
                    ...
                    fn: (scope) => {
                        ...
                        this.$refs.layout.$dialog({
                                ...
                                width: '1000px',
                                params:{
                                    paypalAccountId:scope.row.paypalAccountId,
                                    type:'edit'
                                },
                ...
                },
                {
                    ...
                    icon: 'el-icon-edit-outline',
                    fn: (scope) => {
                        return this.deleteItem(scope.row.paypalAccountId)
                    }
                },
                {
                    name: '操作日志',
