 ...
 * 
 */
export function downloadFile1(url, txt = '下载-' + formatDate(new Date(), '{y}{m}{d}{h}{i}{s}'), _blank, type = '.xlsx') {
    ...
    if (typeof url === 'string') {
        ...
        link.href = url;
        // console.log(txt);
        link.setAttribute("download", name || txt.replace('.xlsx', '') + type || `下载${type}`);
