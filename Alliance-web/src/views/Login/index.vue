  ...
  <div class="user-login" @keyup.enter="submitForm('customRuleForm')">
    ...
    <div class="content-wrapper">
      ...
      <div class="form-container">
        <h4 class="form-title">{{$route.name === 'allotLogin' ? '操作员' : '联盟代理'}}登录</h4>
        <el-form :model="user" label-width="0" :rules="rules" ref="customRuleForm">
          <div class="form-items">
            <!-- <el-row class="form-item" v-if="$route.name === 'allotLogin'">
              <el-col>
            ...
            <el-row class="form-item findPassItem toggle-wrapper">
              <router-link tag="a" class="findPass btn" :to="{name: 'allotLogin'}">操作员登录</router-link>
            </el-row>
          </div>
        </el-form>
      </div>
