<template>
  <div>
    <new-main-layout
      ...
      :columns="columns"
      :edit-btns="edits"
      :outerParams="{platformSiteId: $store.state.currentSiteInfo.selectedSite}"
      ...
      columns: [
          ...
          children: [
            {
              ...
              value: 'platform',
              render(h, scope) {
                return <span>{scope.row.platformSiteName.split('-')[0]}</span>
              }
            },
            {
              label: '站点',
              value: 'site',
              render(h, scope) {
                return <span>{scope.row.platformSiteName.split('-')[1]}</span>
              }
            }
          ]
        },
        ...
        },
        {
          ...
          render(h, scope) {
            ...
            return (
              <div class="link-wrapper-1">
                <span style="width:130px;display: inline-block;vertical-align: bottom;">
                  <el-tooltip content={orderNum} placement="top">
                    <span>{orderNum}</span>
                  </el-tooltip>
                </span>
                <el-button
      ...
      aliColumns: [
        ...
        },
        {
          ...
          render(h, scope) {
            ...
            return (
              <div class="link-wrapper-1">
                <span style="width:20px">{orderNum}</span>
                <el-button
                  type="text"
                  size="small"
                  class="link-btn"
