<template>
  <scroll-bar>
    ...
    <el-menu mode="vertical" :show-timeout="200" background-color="#424F62" text-color="hsla(0, 0%, 100%, .65)" active-text-color="#212732" :default-active="$route.matched[1].path">
