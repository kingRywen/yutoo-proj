<template>
  ...
  <div class='descriptionEditing'>
    ...
    <el-row class='paddingBobbtom'>
      ...
      <!-- <el-button type="success" style="margin-left:20px; " @click="savedVersionSubmit()" v-if="firstPreservation">保存版本1</el-button> -->
      <el-button type="success" style="margin-left:20px; " @click="update()">编辑保存/替换</el-button>
    ...
    <el-button type="success" style=";margin-top:30px; " @click="savedVersionSubmit()">另存为版本</el-button>
  </div>
</template>
