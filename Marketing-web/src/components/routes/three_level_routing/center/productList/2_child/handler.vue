...
<template>
  <div class="__wrapper_i">
    ...
    <div class="margin_bottom8 margin_top8">
      ...
      <el-button v-if="showAddComBut" :disabled="Disabled" type="success" :loading="buttonLoading.funAddCompButtonLoading" @click="funAddComp">加入竞品分析</el-button>
    </div>
...
export default {
  ...
  methods: {
    ...
    funAddComp() {
      ...
      let str = this.AsinArr.join(",");
      this.$store.commit("competitive/type_textarea", str);
