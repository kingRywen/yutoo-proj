  ...
  <div class="chart9" v-loading="Loading">
    ...
    <main style="padding:10px 20px;border:1px solid #e4e4e4;box-size:border-box;">
      ...
      <div v-show="this.chartShow">
        ...
        <echart auto-resize :options="echartData" id="chart9" style="width:100%; height:400px;margin-top:25px;">
        </echart>
      </div>
    </main>
    <!-- 弹窗 todoh-->
...
import { shopDefaultDay, ShopReviewTotalList } from "@/api/myApi";
export default {
  name: "chart9",
