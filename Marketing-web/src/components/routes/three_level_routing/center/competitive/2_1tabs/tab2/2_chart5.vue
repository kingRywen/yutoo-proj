  ...
  <div class="chart5" v-loading="Loading">
    ...
    <main style="padding:10px 20px;border:1px solid #e4e4e4;box-size:border-box;">
      ...
      <div v-show="this.chartShow">
        ...
        <echart auto-resize :options="echartData" id="cate_chart5" style="width:98%; height:400px;margin-top:30px;"></echart>
      </div>
    </main>
  </div>
</template>
...
export default {
  ...
  methods: {
    downloadExl() {
      ...
      // this.$.downloadExl(data, `日新增评价数-详情(类目:${category})`);
    },
    // 点击切换评价选择
    ...
    drawChart(list, usefulIndex, isGetNew, isDataIndex) {
      ...
      let myChart = echarts.init(document.getElementById("cate_chart5"));
      // myChart.clear();
      //
      ...
      this.ex_data = Yarr;
      // 为下载用end
      // console.log(Yarr, "chart5:series");
      // todom
      // 往series里面放值
      //       option.series.push({
      //   name: v.name,
