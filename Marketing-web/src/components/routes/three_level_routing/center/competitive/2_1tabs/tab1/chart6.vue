  ...
  <div class="chart6" v-loading="Loading">
    ...
    <main style="padding:10px 20px;border:1px solid #e4e4e4;box-size:border-box;width:100%">
      ...
      <div v-show="this.chartShow">
        ...
        <echart auto-resize :options="echartData" id="chart6" style="width:95%; height:400px;margin-top:30px;"></echart>
      </div>
    </main>
  </div>
</template>
...
export default {
  ...
  methods: {
    downloadExl() {
      ...
      // console.log(xAxis.data, "xAxis.data");
