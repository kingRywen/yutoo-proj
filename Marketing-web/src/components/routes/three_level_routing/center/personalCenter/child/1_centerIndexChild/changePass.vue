    ...
    <section class="section">
      ...
      <el-form :model="ruleForm" class="__register" :rules="rules" ref="ruleForm">
        <el-form-item prop="oldPassword">
          ...
          <el-input placeholder="请输入原密码" v-model.trim="ruleForm.oldPassword">
        ...
        <el-form-item prop="code">
          <el-row>
            ...
            <el-col :span="5">
              <span v-show="toggleCodeStatus" class="commonPhoneCodeStyle phoneCode" @click="getPhoneCode(2)">获取验证码</span>
        ...
        <el-form-item prop="confirmPassword">
          ...
          <el-input placeholder="再次输入新密码" v-model.trim="ruleForm.confirmPassword">
            <template slot="prepend">
              <span class="required">*</span>
              确认密码
            </template>
        ...
        <el-button type="success" :loading="loading" @click="submitForm('ruleForm','/sys/user/updatePswd',2)" style="width:100%;margin-top:5px;">提交</el-button>
        <!-- <div class="line"></div> -->
      </el-form>
    </section>
  </div>
  ...
  methods: {
    ...
    register(url, messageType) {
      ...
      let data = {
        ...
        pswd: this.ruleForm.oldPassword,
