...
中式扁插
	 ...
	 * 母体估算周销量
	 */
	private Integer weekTargetAll;
	
	/**
	 * 母体估算月销量
	 */
	private Integer monthTargetAll;
	...
	public void setWeekTargetAll(Integer weekTargetAll) {
		this.weekTargetAll = weekTargetAll;
	}
	
	public Integer getWeekTargetAll() {
		return weekTargetAll;
	}
	
	public void setMonthTargetAll(Integer monthTargetAll) {
		this.monthTargetAll = monthTargetAll;
	}
	
	public Integer getMonthTargetAll() {
		return monthTargetAll;
	}
