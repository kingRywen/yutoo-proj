                  ...
                  <v-form :model="ruleForm1" direction="horizontal" :rules="rules1" ref="ruleForm1">
                    ...
                    <div class="group_btn">
                      <v-form-item :label-col="{span:8}" :wrapper-col="{span:16}" label="单个产品尺寸" prop="length">
                        <v-input v-model="ruleForm1.length">
                          <span slot="after">（长/cm）</span>
                        </v-input>
                      </v-form-item>
                      <v-form-item :wrapper-col="{span:24}" prop="wide">
                        <v-input v-model="ruleForm1.wide">
                          <span slot="after">（宽/cm）</span>
                        </v-input>
                      </v-form-item>
                      <v-form-item :wrapper-col="{span:24}" prop="high">
                        <v-input v-model="ruleForm1.high">
                          <span slot="after">（高/cm）</span>
                        </v-input>
                      </v-form-item>
                    </div>
                    <div class="group_btn">
                      <v-form-item :label-col="{span:8}" :wrapper-col="{span:16}" label="外箱包装尺寸" prop="packageLong">
                        <v-input v-model="ruleForm1.packageLong">
                          <span slot="after">（长/cm）</span>
                        </v-input>
                      </v-form-item>
                      <v-form-item :wrapper-col="{span:24}" prop="packageWide">
                        <v-input v-model="ruleForm1.packageWide">
                          <span slot="after">（宽/cm）</span>
                        </v-input>
                      </v-form-item>
                      <v-form-item :wrapper-col="{span:24}" prop="packageHigh">
                        <v-input v-model="ruleForm1.packageHigh">
                          <span slot="after">（高/cm）</span>
                        </v-input>
                      </v-form-item>
                    </div>
                    <div class="group_btn">
                      <v-form-item :label-col="{span:8}" :wrapper-col="{span:16}" label="单个产品重量" prop="grossWeight" :required="true">
                        <v-input v-model="ruleForm1.grossWeight">
                          <span slot="after">（毛重/g）</span>
                        </v-input>
                      </v-form-item>
                      <v-form-item :wrapper-col="{span:24}" prop="netWeight">
                        <v-input v-model="ruleForm1.netWeight">
                          <span slot="after">（净重/g）</span>
                        </v-input>
                      </v-form-item>
                      <v-form-item :wrapper-col="{span:24}" prop="packageWeight">
                        <v-input v-model="ruleForm1.packageWeight">
                          <span slot="after">（包裹重量/g）</span>
                        </v-input>
                      </v-form-item>
                    </div>
                    ...
                    <v-form-item :label-col="{span:3}" :wrapper-col="{span:21}" label="采购价" prop="spurchasePrice" :required="true">
                      <v-input v-model.number="ruleForm1.spurchasePrice"></v-input>
                    </v-form-item>
                    <v-form-item :label-col="{span:3}" :wrapper-col="{span:21}" label="运费" prop="freight">
                      <v-input v-model.number="ruleForm1.freight"></v-input>
                    </v-form-item>
                    ...
                    <v-form-item :label-col="{span:3}" :wrapper-col="{span:21}" label="产品描述" prop="productDesc">
                      <v-input v-model="ruleForm1.productDesc" type="textarea"></v-input>
                    </v-form-item>
                    ...
                    <v-form-item v-show="ruleForm1.plugFlag" :label-col="{span:3}" :wrapper-col="{span:21}" label="强电插头" prop="plugSpec">
                      ...
                      <el-radio-group v-model="ruleForm1.plugSpec">
