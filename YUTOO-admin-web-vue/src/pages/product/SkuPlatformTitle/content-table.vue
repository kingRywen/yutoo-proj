<template lang="html">
    <div class="content">
        ...
        <div class="select flex">
            <p><el-input size="small" v-model.trim="selectName" @change="selectMsgChange"/></p>
        ...
        <div class="content-btn">
            ...
            <el-button size="small" type="primary" @click="$router.back(-1)">返回标题列表</el-button>
        </div>
        <!--  -->
