    ...
    <div class="shop_management">
        ...
        <div style="padding:10px;">
            <div class="search">
                ...
                <el-button type="primary" @click="searchBtn" size="medium">搜 索</el-button>
            </div>
            <div class="operation_btn">
                <el-button type="primary" @click="amendShopData(0,)" size="medium">添 加</el-button>
                <el-button type="primary" @click="onSetVolumeDialog" size="medium">批量设置</el-button>
            </div>
            <!--  -->
            ...
            <div class="shop_lists">
                <el-table
                    ...
                    max-height="580" ref="multipleTable" :data="shopLists" tooltip-effect="dark" style="width: 100%" @selection-change="checks">
                    ...
                    <el-table-column label="平台类型/店铺状态" width="150" show-overflow-tooltip align="center">
                        <template slot-scope="scope">
                            <div class="" style="display:flex;">
                                ...
                                <span style="line-height:40px;margin-left:10px;">{{scope.row.storeStatusDesc}}</span>
                            </div>
                        </template>
                    </el-table-column>
                        ...
                        <template slot-scope="scope">
                            <div class="" style="display:flex;">
                                <el-tooltip  effect="light" placement="right">
                                    ...
                                    <img :src="scope.row.logo || '/static/no-image.jpg'" width="65" height="40">
                                </el-tooltip>
                    ...
                    <el-table-column label="站点" show-overflow-tooltip width='100'>
                        <template slot-scope="scope">
                            <img :src="scope.row.siteEntity.banner" width="65" height="40">
                        </template>
                    </el-table-column>
                    <el-table-column label="VAT税号/税率">
                        <template slot-scope="scope">
                            {{scope.row.vatTaxNum}} / {{scope.row.vatTaxRate?scope.row.vatTaxRate+'%':'-'}}
                        </template>
                    </el-table-column>
                    <el-table-column prop="customsClearName" width="80" label="清关员" show-overflow-tooltip/>
                    <el-table-column prop="salesManName" width="80" label="业务员" />
            ...
            <div class="paginationBox">
                <el-pagination :current-page="currentPage" :page-sizes="[10, 8,5]" :page-size="pageSize" :total="total" layout="total, sizes, prev, pager, next, jumper" @size-change="handleSizeChange" @current-change="changeCurrentPage">
                </el-pagination>
            </div>
                                ...
                                <div class="item">
                                    <el-form-item label="店铺logo：">
                                        <el-upload class="upload-demo"
                                            ...
                                            accept=".jpg,.jpeg,.png,.gif,.JPG,.JPEG,.GIF" list-type="picture">
                        ...
                        <ul class="dialog_content">
                            ...
                            <li>
                                <el-form-item label="国家："
                                    prop="country"
                                    :rules="{required: true, message: '国家不能为空', trigger: 'blur'}">
                            ...
                            <li>
                                <el-form-item label="地址：" style="flex:1"
                                    prop="address"
...
export default {
  ...
  methods: {
    ...
    loadAll() {
      getData("store/list/owner", { owner: this.compileAddForm.owner }).then(
        res => {
          if (res.data.code == 0) {
    ...
    findShopInfo(storeId) {
      getData("store/info", {
        ...
        if (res.data.code == 0) {
          ...
          shopInfo['orderPriorityLevel'] =  shopInfo['orderPriorityLevel']?Number(shopInfo['orderPriorityLevel']):shopInfo['orderPriorityLevel']
          for (let key in shopInfo) {
            for (let i in this.compileAddForm) {
              if (key == i) {
                ...
                this.$set(this.compileAddForm, i, shopInfo[key]);
              }
            }
          }
    ...
    searchBtn() {
      ...
      let params = {
        ...
        platformId: this.search.userSearch.platformId
          ? this.search.userSearch.platformId
          : 1,
