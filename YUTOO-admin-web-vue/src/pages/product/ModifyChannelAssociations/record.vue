    ...
    <div class="record">
        ...
        <div style="padding:10px;">
            ...
            <el-table
                ...
                :data="tableData" tooltip-effect="dark" style="margin-top:15px;width: 100%"  @selection-change="handleSelectionChange" border>
                ...
                <el-table-column  prop="username" label="导入人员" align="center"/>
                <el-table-column  label="下载处理报告"  align="center">
                    <template slot-scope="scope">
                        <el-button type="text" @click="singleDownload(scope.row.uploadRecordId)">下载</el-button>
                    </template>
                </el-table-column>
            </el-table>
    ...
    methods: {
        ...
        alldownload() {
            if (this.selectList.length) {
                this.download("GlobalUploadRecord/batchDownload",{ids:this.selectList})
            } else {
                this.$message({
        ...
        singleDownload(globalUploadRecordId) {
           this.download("GlobalUploadRecord/download",{globalUploadRecordId})
        },
        reacquire(pageNumber=1,pageSize=10){
            ...
            if(this.selectInfo.time !=null && this.selectInfo.time.length){
                params = {...params,startDate:this.selectInfo.time[0],endDate:this.selectInfo.time[1]}
            }
            this.getTheRecord(params)
        },
        //搜索
