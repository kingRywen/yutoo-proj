    ...
    <v-data-table stripe :tree-option='treeOption' ref="table" :data='list' :columns='columns' check-type="checkbox" class="margin-top-25" :current-data.sync='tableData'>
      <template slot="td" slot-scope="props">
        ...
        <div v-else-if="props.column.field=='relNum'">
          <dynamicInput :disabled="$attrs.show" :isInput="props.item.isInput" type="num" :item="props" :text="props.content" @edit="updateName(props, $event)" @cancel="cancel(props, $event)"></dynamicInput>
        </div>
