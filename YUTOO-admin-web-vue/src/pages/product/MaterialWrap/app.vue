<template lang="html">
    <div class="logistics_packaging">
        ...
        <div class="content">
            ...
            <!--  -->
            <el-row  class="btn">
                 <el-button type="primary"  size="medium" @click="openDialog('添加包材')">添 加</el-button>
                 <el-button type="primary"  size="medium" @click="allDel">批量删除</el-button>
            </el-row>
            <!--  -->
            <el-table :data="packageList" border style="width: 100%" height="480"  @selection-change="handleSelectionChange">
