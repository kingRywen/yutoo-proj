                ...
                <el-main class="auto">
                    ...
                    <el-form :inline="true" :model="selectInfo" class="selectInfo">
                        <el-form-item label="站点">
                            <el-select size="small" v-model="selectInfo.siteId" clearable >
                    ...
                    <el-table :data="tableData" v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
                        ...
                        <el-table-column  prop="storeName"  label="店铺"  width="180" align="center"></el-table-column>
                        <el-table-column    label="产品图片" align="center">
                            <template slot-scope="scope">
                               <img :src="scope.row.img" alt="" width="67" height="37">
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column  prop="repertory"  label="本地仓库结余" align="center"></el-table-column>
                        <el-table-column  prop="price"  label="售价" align="center"></el-table-column>
                        <el-table-column  prop="repertory"  label="FBA状态" align="center"></el-table-column>
                    </el-table>
                    <!-- 分页 -->
