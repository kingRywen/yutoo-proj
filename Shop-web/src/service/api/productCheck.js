export default [
	...
	{
	    name: 'keywordConfigGetBackConfig',
	    method: 'POST',
	    desc: '获取后台词配置',
	    path: '/keywordConfig/getBackConfig',
	    mock: true,
	    // showSuccess: true,
	},
	{
	    name: 'productKeywordVerifyGenerationKeywordTool',
	    method: 'POST',
	    desc: '关键词生成工具',
	    path: '/productKeywordVerify/generationKeywordTool',
	    mock: true,
	    showSuccess: true,
	},
	{
	    name: 'productKeywordVerifyGenerationKeywordToolNew',
	    method: 'POST',
	    desc: '关键词生成工具(新)',
	    path: '/productKeywordVerify/generationKeywordToolNew',
	    mock: true,
	    showSuccess: true,
	},
]