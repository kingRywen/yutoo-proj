<template>
    <div>
        <MainLayout
            ...
            ref="layout"
            url="selAttrProductPopularAnalysis"
        >  
        </MainLayout>
        <a href="" ref='link'></a>
    </div>
...
<script>
import diaVue from '../../demo/components/dia.vue';
export default {
                 ...
                 columns: [
                    {
                        ...
                        render(h,scope){
                            //console.log(scope);
                            //console.log(vm.$refs.layout.pageNo);
    ...
    methods: {
        ...
        //导出
            exportBtn(){
                ...
                return this.$api['selAttrProductExportPopularAttr'](datas)
                .then(data => {
                    let url = window.URL.createObjectURL(new Blob([data]));
                    let a = this.$refs.link;
                    a.href = url;
                    a.setAttribute("download", "爆款属性分析.xlsx");
                    a.click();
