<template>
    <div>
        <MainLayout
            ...
            ref="layout"
            url="taskProductTrendAnalysisListTask"
            > 
            ...
            //columns表格
                 columns: [
                    ...
                    },
                    {
                        ...
                        render(h,scope){
                            return(
                                <span>{scope.row.dataType===0?'店铺链接':scope.row.dataType===1?'Top100链接':'产品链接'}</span>
                            )
                        }
                    },
                    {
    ...
    methods: {
        ...
        //删除按钮
            delBtn(){
                ...
                return this.$confirm('此操作将永久删除数据, 是否继续?', '提示', {
                    ...
                    return this.$api['taskProductTrendAnalysisBatchRemove'](
                        {
        ...
        //重新抓取数据
            refetchData(){
                ...
                return this.$api['taskProductTrendAnalysisReExecute'](
                    {
                        sellerId:this.sellerId,
                        siteId:this.siteId,
                        ids:this.selectIds
        ...
        //查看详情
            lookDatsils(n){
                 this.$router.push(
                    {path:'/selection/trendAnalyses/productDatails',
                    query:{
        ...
        //刷新单条数据
            refetchOneData(v){
                this.$api['taskProductTrendAnalysisReExecute'](
                    {
                        sellerId:this.sellerId,
                        siteId:this.siteId,
                        ids:[v]
