	...
	getList(){
		...
		this.$api['homeCusMsgRecList'](params).then((data)=>{
			...
			this.messageList.push({
				buyerMsg: 1,
				msgBody: "gdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsg",
				msgDate: "2019-06-25 16:26:10",
				msgId: 1517826682763340800,
			},{
				buyerMsg: 0,
				msgBody: "gdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsggdgsg",
				msgDate: "2019-06-25 16:26:10",
