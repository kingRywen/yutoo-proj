...
export default {
    ...
    return {
      ...
      showCate: {
        ...
        table: {
          ...
          show: {
            ...
            fbaProductCnt: true,
            fbaProductRate: true,
            fbmProductCnt_text: true,
            fbmProductRate: true,
            salesProductCnt: true,
            salesProductRate: true,
            noSalesProductCnt: true,
            noSalesProductRate: true,
            monthNewProductCnt: true,
            top10ProdNewReviewCnt: true
          }
        }
      },
      chartData: {
      ...
      table: {
        ...
        show: {
          ...
          newFeedbackCntD30_label: "店铺月新增Feedback数",
          // newFeedbackCntD90: true,
          // feedbackCnt: true,
          // openTime: true,
          // categoryCntAmazon: true,
          Handle: {
            showChart: true
          }
        }
  ...
  methods: {
    ...
    downloadFun() {
      ...
      this.$ajax({
        method: "post",
        url: BASE_URL + "taskCategoryDepthAnalysis/exportSellerDetails",
        data: params,
        responseType: "blob"
      })
        .then(data => {
          ...
          y.href = url;
          y.setAttribute("download", "Amazon深度分析卖家分析.xlsx");
          y.click();
    ...
    getList(arg) {
      ...
      return this.$api["TaskCateDepthAnalysisSouqSellerDetailsAmazon"](params)
        .then(data => {
    ...
    getShowCateList(arg) {
      ...
      this.$api["TaskCateDepthAnalysisSouqListToCategoryBySellerAmazon"](params)
        .then(data => {
