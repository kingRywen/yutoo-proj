		    ...
		    <el-row :gutter="20">
		        ...
		        <el-col :span="10">
		            <div class="grid-content bg-purple">
		                ...
		                <NonePage v-else ></NonePage>
						<div v-if="oldPushId.length==0 && isShowTip" style="color: #f56c6c;font-size: 12px;">请添加至少一个商品！</div>
		            </div>
		        </el-col>
		    </el-row>
		</div>
...
export default {
    ...
    methods: {
		validateFn(){
			if(this.oldPushId && this.oldPushId.length){
				this.isShowTip = false
				return Promise.resolve(this.oldPushId)
			}else{
				this.isShowTip = true
