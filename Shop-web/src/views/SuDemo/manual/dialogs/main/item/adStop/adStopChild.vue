...
<script>
	...
	import {toCNStrZB,initData,strategyText} from 'Views/SuDemo/manual/js/adStop.js'
	export default {
		props: ["params"],
		data() {
			let vm = this
				...
				edits: [
					{
					    ...
					    fn: (scope) => {
							vm.$refs.layout.$dialog({
								...
								component: () => import(`Views/SuDemo/manual/dialogs/main/item/adStop/addNocl.vue`),
								okBtnText:'确认',
								cancelBtnText:'取消'
							})
					    }
