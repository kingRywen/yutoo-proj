				...
				<el-form-item label-position="right" label-width="78px">
					...
					<div style="display: flex;">
						...
						<!-- <el-form-item  style="margin-left: 20px;">
							<el-button @click="testMethod" type="primary" size="small" plain>测试</el-button>
						</el-form-item>	 -->
					</div>		
				</el-form-item>
			</div>
			...
			<div>
				<div v-for="(item,index) in formData.strategy" style="width:100%;height:auto;margin-top: 10px;">
					...
					<div class="rule_content" style="width: 100%;height: auto;padding: 10px;border: 1px solid rgb(242,242,242);" :style="{display:item.divDisplay}">					
						<el-form-item class="form_item" prop="expression"   >						
							<div class="lebelBox">
								<div class="lebelBtn">
...
<script>
	...
	import {toCNStrZB} from 'Views/SuDemo/manual/js/noWord.js'
	export default {
		props: ["params","type"],
		data() {
			let vm = this
				...
				edits: [
					{
					    ...
					    fn: (scope) => {
							vm.$refs.layout.$dialog({
								...
								component: () => import(`Views/SuDemo/manual/dialogs/main/item/addNoCl.vue`),
								okBtnText:'确认',
								cancelBtnText:'取消'
							})
					    }
		...
		methods: {
			...
			validateFn(){
				if(this.type === 'first'){
					//广告词
					return this.$refs.formData.validate().then(()=>{}).catch(()=>{
