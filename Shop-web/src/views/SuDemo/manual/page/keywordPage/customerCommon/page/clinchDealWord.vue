				...
				edits:[
					{
					    ...
					    fn: (scope) => {
							this.$refs.layout.$dialog({
								...
								width: '1200px',
								showMaxBtn: true,
								params: { dealFlag:1,keywordQuery: scope.row.keywordQuery, adGroupIds: [this.$route.query.objectId],keywordIds:this.$parent.$parent.$parent.keywordIds && this.$parent.$parent.$parent.keywordIds.length ? this.$parent.$parent.$parent.keywordIds : null ,url:'adKeywordQueryAdHistoryStat'},
