				...
				editBtns:[
					{
						...
						fn: ()=>{
							vm.$refs.layout.$dialog({
							  ...
							  width:'500px',
							  params:{
								  parentTaskId:vm.outerParams.parentTaskId
							  },
							  component: () => import("Views/AD_Management/adTargetingSource/dialog/add.vue"),
							  cancelBtnText:'取消',
							  okBtnText:'确认'
							});
						}
						    ...
						    <el-button
						      ...
						      onClick={() => {
						        ...
						        vm.$refs.layout.$dialog({
						          ...
						          component: () => import("Views/AD_Management/adTargetingSource/dialog/table.vue")
						        });
						      }}
						    >
