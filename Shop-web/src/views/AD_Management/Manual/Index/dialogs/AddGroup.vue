...
export default {
  ...
  data() {
    let vm = this
    //console.log(vm.params.treeList);
    ...
    _submit() {
      ...
      return this.$refs.form.validate().then(() => {
        ...
        return this.$api[
          ...
          let specials = ['添加分组', '添加下级分组', '编辑分组', '删除分组']
          //debugger
          if (specials.indexOf(vm.params.title) === -1) {
            vm.params.parent.getTaskClassifyList()
          } else {
            vm.params.parent.updateTree(vm.params.title, parentClassifyId)
          }
