		...
		<!-- <template slot="search">
			<el-form :inline="true" ref="searchRuleForm" :model="listQuery"  :rules="rules" >
				<el-form-item label="广告系列" prop="campaignIds" v-show="searchIsShow.campaignIds">
					<el-select v-on:blur="blurMethod" style="width: 440px;" filterable  multiple collapse-tags v-model="listQuery.campaignIds" size='small' clearable @change="changeMethod0">
				...
				<el-form-item label="花费占比" prop="acosMin1" v-show="searchIsShow.acos">
	...
	export default{
				...
				edits:[
					{
					    ...
					    fn: (scope) => {
							this.$refs.layout.$dialog({
								...
								width: '1200px',
								showMaxBtn: true,
								params: { dealFlag:1,keywordQuery: scope.row.keywordQuery, campaignIds: vm.$parent.$parent.$parent.listQuery.campaignIds && vm.$parent.$parent.$parent.listQuery.campaignIds.length ? vm.$parent.$parent.$parent.listQuery.campaignIds : null,adGroupIds: vm.$parent.$parent.$parent.listQuery.adGroupIds && vm.$parent.$parent.$parent.listQuery.adGroupIds.length ? vm.$parent.$parent.$parent.listQuery.adGroupIds : null,keywordIds: vm.$parent.$parent.$parent.listQuery.keywordIds && vm.$parent.$parent.$parent.listQuery.keywordIds.length ? vm.$parent.$parent.$parent.listQuery.keywordIds : null,url:'adKeywordQueryAdHistoryStat'},
		...
		methods:{
			...
			searchFunc(data){
				...
				// let datas = data
				// let { time,clickRatesMin1,clickRatesMax1,adConversionRatesMin1,adConversionRatesMax1,acosMin1,acosMax1, ...info} = datas
				// let [startTime, endTime] = time || [];
				// //百分数转小数处理
				// let clickRatesMin = clickRatesMin1 ? clickRatesMin1/100 : null;
				// let clickRatesMax = clickRatesMax1 ? clickRatesMax1/100 : null;
				// let adConversionRatesMin = adConversionRatesMin1 ? adConversionRatesMin1/100 : null;
				// let adConversionRatesMax = adConversionRatesMax1 ? adConversionRatesMax1/100 : null;
				// let acosMin = acosMin1 ? acosMin1/100 : null;
				// let acosMax = acosMax1 ? acosMax1/100 : null;
				// return { startTime, endTime,clickRatesMin,clickRatesMax,adConversionRatesMin,adConversionRatesMax,acosMin,acosMax, ...info };
			},
			getOption(){
				this.getOption0()
			},
