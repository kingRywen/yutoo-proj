                ...
                columns:[
                    ...
                    },
                    {
                    ...
                    },
                     {
                        ...
                        render(h,scope){
                            return(
                                <a href={scope.row.productUrl} style={{color:"#108ee9"}} target="-blink">{scope.row.asin}</a>
                            )
                        }
                    },
                    {
    ...
    methods: {
        ...
        //导出
            exportBtn(){
                ...
                return this.$api['taskClaimLostExportData'](
                    data
                )
                .then(data => {
                    ...
                    a.href = url;
                    a.setAttribute("download", "亚马逊丢件库存，未赔偿.xlsx");
                    a.click();
