    ...
    activeFields() {
      return [
        ...
        },
        {
          ...
          span: 24,
          // required: this.params ? true : false
        },
        {
          label: '是否同款属性',
          name: 'sameAttrFlag',
    ...
    _submit() {
      return this.$refs.form.validate().then(() => {
        ...
        const params = {
          ...
          name,
          parentName,
          attrId: this.params && this.params.attrId,
          ...this.$.dealObjectValue(this.formData)
        }
        return this.$api[
          !this.params.add
            ? `sameAttrConfigDetailUpdate`
            : `sameAttrConfigDetailSave`
        ](params)
      })
    },
    getInfo() {
