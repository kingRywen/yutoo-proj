    ...
    _submit() {
      return this.$refs.form.validate().then(() => {
			...
			if (this.params.isControl) {
				...
				return this.$api[this.params.editControl?'ebTaskKrResearchUpdateMonitor':'ebTaskKrResearchAddMonitor'](datas).then(data=>{
				...
				datas.frequency = parseInt(datas.frequency)
				return this.$api[`ebTaskKrResearchSave`](datas).then(data=>{
					return  Promise.resolve("reset");
				})	  
			}
