<template>
	<div>
		<div v-if="$route.name==='ebayNaturalSearchRankingStudy'">
			<MainLayout
	...
	export default{
			...
			return{
				columns:[
					...
					},
					{
						...
						value:'createTime',
						// render(h,scope){
						// 	let {createTime} = scope.row
						// 	let newTime = createTime.split(' ')[0]
		...
		methods:{
			...
			stopBtn(e) {
				...
				this.$api[e==='del'?'ebTaskKrResearchRemove':"ebTaskKrResearchCancelMonitor"]({
