<template>
	<div>
		<div v-if="$route.name==='ebayCategoryAnalysisItem'">
		 <MainLayout
	...
	export default{
		...
		methods:{
			...
			taskIdsMethod(e){
				...
				this.$confirm(`此操作将${e==='del'?'删除':'抓取数据'},是否继续？`,'提示',{type:'warning'}).then(()=>{
					this.$api[e==='del'?'ebTaskCateAysRemove':"ebTaskCateAysReCrawl"]({
