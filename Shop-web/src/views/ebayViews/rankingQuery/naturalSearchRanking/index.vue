...
export default {
	...
	methods: {
		...
		//重新抓取
			refetchOneData(v){
				this.$api['ebTaskKeywordRankReCrawl']({
					taskIds:[v]
				})
				.then(data => {
			...
			delBtn(){
				...
				this.$confirm('此操作将永久删除该任务, 是否继续?', '提示', {
					...
					type: 'warning'
						...
						this.$api['ebTaskKeywordRankRemove']({
		...
		//开启监控
			startMonitoring(){
				...
				this.$refs.layout.$dialog({
					title: "添加监控",
					size:'small',
					params: {taskIds:this.slectIds,url:"ebTaskKeywordRankAddMonitor"},
		...
		//修改监控
			alertMonitoring(){
				...
				this.$refs.layout.$dialog({
					title: "修改监控",
					size:'small',
					params: {taskIds:this.slectIds,url:'ebTaskKeywordRankUpdateMonitor'},
					component: () => import('./common/startMonitoringDialog.vue'),
					okBtnText: "确认",
					cancelBtnText: "取消"
				});
		...
		//点击列表的单个的修改
			onealertMonitoring(v,data){
				this.$refs.layout.$dialog({
					title: "修改监控",
					size:'small',
					params: {taskIds:[v],url:'ebTaskKeywordRankUpdateMonitor',datas:data},
					component: () => import('./common/startMonitoringDialog.vue'),
					okBtnText: "确认",
					cancelBtnText: "取消"
				});
			...
			endMonitoring(){
				...
				this.$confirm('此操作将永久取消该监控, 是否继续?', '提示', {
					...
					type: 'warning'
						...
						this.$api['ebTaskKeywordRankRemoveMonitor']({
							taskIds:this.slectIds
						})
						.then(data => {
							this.$refs.layout.getList()
