  ...
  <div class="chartRank" v-loading="dialogLoading">
    <header style="position:relative">
      <div style="position:absolute;left:0px;top:-3px;">
        <el-date-picker
          :picker-options="cfuns.onlyTwoYear"
          unlink-panels
          :style="{width:DateMsg.width}"
          v-model="DateMsg.DateValue"
          @change="changeTime"
...
export default {
  ...
  methods: {
    ...
    showChartChild(parentAsin, startTime, endTime) {
      ...
      this.$api['TaskCateAnalysisSouqListToNewReviewCnByCateAmazon'](opts)
        .then(data => {
