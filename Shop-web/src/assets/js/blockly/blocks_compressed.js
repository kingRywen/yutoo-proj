...
Blockly.Constants.Logic.LOGIC_COMPARE_ONCHANGE_MIXIN = {
	onchange: function(a) {
		...
		b && c && !b.outputConnection.checkType_(c.outputConnection) && (Blockly.Events.setGroup(a.group), a = this.prevBlocks_[
				0], a !== b && (b.unplug(), a && !a.isShadow() && this.getInput("A").connection.connect(a.outputConnection)), b =
			this.prevBlocks_[1], b !== c && (c.unplug(), b && !b.isShadow() && this.getInput("B").connection.connect(b.outputConnection)),
...
Blockly.Constants.Logic.LOGIC_TERNARY_ONCHANGE_MIXIN = {
	...
	onchange: function(a) {
		...
		if ((b || c) && d)
			for (var e = 0; 2 > e; e++) {
				var f = 1 == e ? b : c;
				f && !f.outputConnection.checkType_(d) && (Blockly.Events.setGroup(a.group), d === this.prevParentConnection_ ? (
					this.unplug(), d.getSourceBlock().bumpNeighbours_()) : (f.unplug(), f.bumpNeighbours_()), Blockly.Events.setGroup(
					!1))
			}
...
Blockly.Blocks.procedures_defnoreturn = {
	...
	renameVarById: function(a, b) {
		...
		if ("" == c.type) {
			c = c.name;
			for (var d = this.workspace.getVariableById(b), e = !1, f = 0; f < this.argumentVarModels_.length; f++) this.argumentVarModels_[
				f].getId() == a && (this.arguments_[f] = d.name, this.argumentVarModels_[f] = d, e = !0);
...
Blockly.Blocks.procedures_mutatorcontainer = {
	...
	onchange: function(a) {
		if (this.workspace && !this.workspace.isFlyout &&
			...
			} else if (a.type == Blockly.Events.BLOCK_CREATE && (c = this.workspace.getBlockById(a.blockId), c.getField("NAME") &&
					(d = c.getFieldValue("NAME"),
						(a = this.workspace.getVariable(d)) || (a = this.workspace.createVariable(d)), !c.previousConnection.isConnected() &&
			...
			if (a.join("\n") == this.arguments_.join("\n")) this.quarkIds_ = b;
				...
				for (var e = 0; e < this.arguments_.length; e++) {
					...
					f && (f = f.connection.targetConnection, this.quarkConnections_[this.quarkIds_[e]] = f, d && f && -1 == b.indexOf(
						this.quarkIds_[e]) && (f.disconnect(), f.getSourceBlock().bumpNeighbours_()))
				}
				...
				this.updateShape_();
				if (this.quarkIds_ = b)
					for (e = 0; e < this.arguments_.length; e++) d = this.quarkIds_[e], d in this.quarkConnections_ && (f = this.quarkConnections_[
						d], Blockly.Mutator.reconnect(f, this, "ARG" + e) || delete this.quarkConnections_[d]);
		...
		if (this.workspace &&
			...
			if (a.type == Blockly.Events.BLOCK_CREATE && -1 != a.ids.indexOf(this.id)) {
				...
				if (!b) {
					...
					this.dispose(!0, !1), Blockly.Events.setGroup(!1))) : a.type == Blockly.Events.CHANGE && "disabled" == a.element &&
