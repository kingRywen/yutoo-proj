...
goog.getScriptNonce_ = function(a) {
	return (a = a.querySelector && a.querySelector("script[nonce]")) && (a = a.nonce || a.getAttribute("nonce")) && goog.NONCE_PATTERN_
		.test(a) ? a : ""
};
goog.VALID_MODULE_RE_ = /^[a-zA-Z_$][a-zA-Z0-9._$]*$/;
goog.module = function(a) {
	if (!goog.isString(a) || !a || -1 == a.search(goog.VALID_MODULE_RE_)) throw Error("Invalid module identifier");
	if (!goog.isInGoogModuleLoader_()) throw Error("Module " + a +
...
goog.declareModuleId = function(a) {
	if (!COMPILED) {
		...
		if (goog.moduleLoaderState_ && goog.moduleLoaderState_.moduleName) throw Error(
...
goog.loadModule = function(a) {
	...
	try {
		...
		if (goog.isString(d) && d) goog.moduleLoaderState_.declareLegacyNamespace ? goog.constructNamespace_(d,
			c) : goog.SEAL_MODULE_EXPORTS && Object.seal && "object" == typeof c && null != c && Object.seal(c), goog.loadedModules_[
			d] = {
			exports: c,
			type: goog.ModuleType.GOOG,
...
goog.base = function(a, b, c) {
	...
	if ("string" != typeof b && "symbol" != typeof b) throw Error(
...
!COMPILED && goog.DEPENDENCIES_ENABLED && (goog.inHtmlDocument_ = function() {
		...
		if (goog.isDef(goog.global.CLOSURE_BASE_PATH) && goog.isString(goog.global.CLOSURE_BASE_PATH)) goog.basePath = goog.global
			.CLOSURE_BASE_PATH;
		...
		if (a in this.requiresTranspilation_) return this.requiresTranspilation_[a] ? !0 : !goog.inHtmlDocument_() || "es6" !=
	...
	}, goog.LoadController = function() {}, goog.LoadController.prototype.pause = function() {}, goog.LoadController.prototype
	.resume = function() {}, goog.LoadController.prototype.loaded = function() {}, goog.LoadController.prototype.pending =
	function() {}, goog.LoadController.prototype.registerEs6ModuleExports = function(a,
		b, c) {}, goog.LoadController.prototype.setModuleState = function(a) {}, goog.LoadController.prototype.clearModuleState =
	function() {}, goog.LoadController.prototype.defer = function(a) {}, goog.LoadController.prototype.areDepsLoaded =
	function() {}, goog.Dependency = function(a, b, c, d, e) {
		this.path = a;
		this.relativePath = b;
		this.provides = c;
		this.requires = d;
	...
	function(a) {
		...
		if (goog.global.CLOSURE_IMPORT_SCRIPT) goog.global.CLOSURE_IMPORT_SCRIPT(this.path) ? a.loaded() : a.pause();
			...
			if (!goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING && goog.isDocumentLoading_()) {
				...
				d = '<script src="' + this.path + '" ' + (goog.DebugLoader_.IS_OLD_IE_ ? "onreadystatechange" : "onload") +
					"=\"goog.Dependency.callback_('" + c + '\', this)" type="text/javascript" ' + (goog.Dependency.defer_ ? "defer" :
						"") + d + ">\x3c/script>";
		...
		} else goog.logToConsole_("Cannot use default debug loader outside of HTML documents."), "deps.js" == this.relativePath ?
			(goog.logToConsole_(
		...
		function b(a, b) {
			var c = b ? '<script type="module" crossorigin>' + b + "\x3c/script>" : '<script type="module" crossorigin src="' +
				a + '">\x3c/script>';
		...
		function c(a, b) {
			...
			b ? c.textContent = goog.TRUSTED_TYPES_POLICY_ ? goog.TRUSTED_TYPES_POLICY_.createScript(b) : b : c.src = goog.TRUSTED_TYPES_POLICY_ ?
				goog.TRUSTED_TYPES_POLICY_.createScriptURL(a) : a;
		...
		function d() {
			var a = goog.global.document,
				...
				d = '<script type="text/javascript">' + goog.protectScriptTag_('goog.Dependency.callback_("' + b + '");') +
				"\x3c/script>";
		...
		this.transpiler = f
	}, goog.inherits(goog.TranspiledDependency, goog.TransformedDependency), goog.TranspiledDependency.prototype.transform =
	function(a) {
		return this.transpiler.transpile(a, this.getPathName())
	},
	goog.PreTranspiledEs6ModuleDependency = function(a, b, c, d, e) {
		goog.TransformedDependency.call(this, a, b, c, d, e)
	}, goog.inherits(goog.PreTranspiledEs6ModuleDependency, goog.TransformedDependency), goog.PreTranspiledEs6ModuleDependency
	...
	function(a) {
		...
		return goog.LOAD_MODULE_USING_EVAL && goog.isDef(goog.global.JSON) ? "goog.loadModule(" + goog.global.JSON.stringify(
			...
			"\n;return exports});\n//# sourceURL=" + this.path + "\n"
	}, goog.DebugLoader_.IS_OLD_IE_ = !(goog.global.atob || !goog.global.document || !goog.global.document.all), goog.DebugLoader_
	.prototype.addDependency = function(a, b,
		c, d) {
		b = b || [];
		a = a.replace(/\\/g, "/");
		...
		return e.module == goog.ModuleType.GOOG ? new goog.GoogModuleDependency(a,
				b, c, d, e, f, this.transpiler) : f ? new goog.TranspiledDependency(a, b, c, d, e, this.transpiler) : e.module ==
			goog.ModuleType.ES6 ? "never" == goog.TRANSPILE && goog.ASSUME_ES_MODULES_TRANSPILED ? new goog.PreTranspiledEs6ModuleDependency(
				a, b, c, d, e) : new goog.Es6ModuleDependency(a, b, c, d, e) : new goog.Dependency(a, b, c, d, e)
...
goog.TRUSTED_TYPES_POLICY_ = goog.TRUSTED_TYPES_POLICY_NAME ? goog.createTrustedTypesPolicy(goog.TRUSTED_TYPES_POLICY_NAME +
	"#base") : null;
goog.debug = {};
...
goog.asserts.assertExists = function(a, b, c) {
	goog.asserts.ENABLE_ASSERTS && null == a && goog.asserts.doAssertFailure_("Expected to exist: %s.", [a], b, Array.prototype
...
goog.string.internal.htmlEscape = function(a, b) {
	if (b) a = a.replace(goog.string.internal.AMP_RE_, "&amp;").replace(goog.string.internal.LT_RE_, "&lt;").replace(goog
		.string.internal.GT_RE_, "&gt;").replace(goog.string.internal.QUOT_RE_, "&quot;").replace(goog.string.internal.SINGLE_QUOTE_RE_,
		"&#39;").replace(goog.string.internal.NULL_RE_, "&#0;");
	else {
		if (!goog.string.internal.ALL_RE_.test(a)) return a; - 1 != a.indexOf("&") && (a = a.replace(goog.string.internal.AMP_RE_,
			"&amp;")); - 1 != a.indexOf("<") && (a = a.replace(goog.string.internal.LT_RE_,
			"&lt;")); - 1 != a.indexOf(">") && (a = a.replace(goog.string.internal.GT_RE_, "&gt;")); - 1 != a.indexOf('"') && (
			a = a.replace(goog.string.internal.QUOT_RE_, "&quot;")); - 1 != a.indexOf("'") && (a = a.replace(goog.string.internal
			.SINGLE_QUOTE_RE_, "&#39;")); - 1 != a.indexOf("\x00") && (a = a.replace(goog.string.internal.NULL_RE_, "&#0;"))
	}
	return a
};
...
goog.string.internal.compareVersions = function(a, b) {
	for (var c = 0, d = goog.string.internal.trim(String(a)).split("."), e = goog.string.internal.trim(String(b)).split(
...
goog.labs.userAgent.browser.matchSafari_ = function() {
	return goog.labs.userAgent.util.matchUserAgent("Safari") && !(goog.labs.userAgent.browser.matchChrome_() || goog.labs
		.userAgent.browser.matchCoast_() || goog.labs.userAgent.browser.matchOpera_() || goog.labs.userAgent.browser.matchEdgeHtml_() ||
		goog.labs.userAgent.browser.matchEdgeChromium_() || goog.labs.userAgent.browser.matchOperaChromium_() || goog.labs.userAgent
		.browser.matchFirefox_() || goog.labs.userAgent.browser.isSilk() || goog.labs.userAgent.util.matchUserAgent(
			"Android"))
};
...
goog.labs.userAgent.browser.matchIosWebview_ = function() {
	return (goog.labs.userAgent.util.matchUserAgent("iPad") || goog.labs.userAgent.util.matchUserAgent("iPhone")) && !
		...
		.matchCoast_() && !goog.labs.userAgent.browser.matchFirefox_() && goog.labs.userAgent.util.matchUserAgent(
			"AppleWebKit")
};
...
goog.labs.userAgent.browser.getVersion = function() {
	...
	return goog.labs.userAgent.browser.isOpera() ? a(["Version", "Opera"]) : goog.labs.userAgent.browser.isEdge() ? a([
		...
		goog.labs.userAgent.browser.isEdgeChromium() ? a(["Edg"]) : goog.labs.userAgent.browser.isChrome() ? a(["Chrome",
			"CriOS"
		]) : (b = b[2]) && b[1] || ""
};
...
goog.dom.asserts.assertIsLocation = function(a) {
	if (goog.asserts.ENABLE_ASSERTS) {
		...
		b && (!a || !(a instanceof b.Location) && a instanceof b.Element) && goog.asserts.fail(
...
goog.dom.asserts.assertIsElementType_ = function(a, b) {
	if (goog.asserts.ENABLE_ASSERTS) {
		...
		c && "undefined" != typeof c[b] && (a && (a instanceof c[b] || !(a instanceof c.Location || a instanceof c.Element)) ||
			goog.asserts.fail("Argument is not a %s (or a non-Element, non-Location mock); got: %s", b, goog.dom.asserts.debugStringForType_(
				a)))
	}
	return a
};
...
goog.html.trustedtypes.PRIVATE_DO_NOT_ACCESS_OR_ELSE_POLICY = goog.TRUSTED_TYPES_POLICY_NAME ? goog.createTrustedTypesPolicy(
	goog.TRUSTED_TYPES_POLICY_NAME + "#html") : null;
goog.string.TypedString = function() {};
goog.string.Const = function(a, b) {
	this.stringConstValueWithSecurityContract__googStringSecurityPrivate_ = a === goog.string.Const.GOOG_STRING_CONSTRUCTOR_TOKEN_PRIVATE_ &&
		b || "";
...
goog.html.SafeScript.fromConstantAndArgs = function(a, b) {
	...
	return goog.html.SafeScript.createSafeScriptSecurityPrivateDoNotAccessOrElse("(" + goog.string.Const.unwrap(a) + ")(" +
		c.join(", ") + ");")
};
...
goog.html.SafeScript.prototype.initSecurityPrivateDoNotAccessOrElse_ = function(a) {
	this.privateDoNotAccessOrElseSafeScriptWrappedValue_ = goog.html.trustedtypes.PRIVATE_DO_NOT_ACCESS_OR_ELSE_POLICY ?
		goog.html.trustedtypes.PRIVATE_DO_NOT_ACCESS_OR_ELSE_POLICY.createScript(a) : a;
	return this
};
...
goog.i18n.bidi.IS_RTL = goog.i18n.bidi.FORCE_RTL || ("ar" == goog.LOCALE.substring(0, 2).toLowerCase() || "fa" == goog.LOCALE
	...
	.LOCALE.substring(0, 3).toLowerCase() && (3 == goog.LOCALE.length || "-" == goog.LOCALE.substring(3, 4) || "_" == goog
		.LOCALE.substring(3, 4)) || 7 <= goog.LOCALE.length && ("-" == goog.LOCALE.substring(2, 3) || "_" == goog.LOCALE.substring(
		2, 3)) && ("adlm" == goog.LOCALE.substring(3, 7).toLowerCase() || "arab" == goog.LOCALE.substring(3, 7).toLowerCase() ||
		"hebr" == goog.LOCALE.substring(3, 7).toLowerCase() || "nkoo" == goog.LOCALE.substring(3,
			7).toLowerCase() || "rohg" == goog.LOCALE.substring(3, 7).toLowerCase() || "thaa" == goog.LOCALE.substring(3, 7).toLowerCase()
	) || 8 <= goog.LOCALE.length && ("-" == goog.LOCALE.substring(3, 4) || "_" == goog.LOCALE.substring(3, 4)) && ("adlm" ==
		goog.LOCALE.substring(4, 8).toLowerCase() || "arab" == goog.LOCALE.substring(4, 8).toLowerCase() || "hebr" == goog.LOCALE
		.substring(4, 8).toLowerCase() || "nkoo" == goog.LOCALE.substring(4, 8).toLowerCase() || "rohg" == goog.LOCALE.substring(
			4, 8).toLowerCase() || "thaa" == goog.LOCALE.substring(4, 8).toLowerCase());
...
goog.html.TrustedResourceUrl.prototype.cloneWithParams = function(a, b) {
	...
	var d = c[3] || "";
	return goog.html.TrustedResourceUrl.createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse(c[1] + goog.html.TrustedResourceUrl
		.stringifyParams_("?", c[2] || "", a) + goog.html.TrustedResourceUrl.stringifyParams_("#", d, b))
};
...
goog.html.TrustedResourceUrl.createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse = function(a) {
	...
	b.privateDoNotAccessOrElseTrustedResourceUrlWrappedValue_ = goog.html.trustedtypes.PRIVATE_DO_NOT_ACCESS_OR_ELSE_POLICY ?
		goog.html.trustedtypes.PRIVATE_DO_NOT_ACCESS_OR_ELSE_POLICY.createScriptURL(a) : a;
	goog.html.trustedtypes.PRIVATE_DO_NOT_ACCESS_OR_ELSE_POLICY && (b.trustedURL_ = goog.html.trustedtypes.PRIVATE_DO_NOT_ACCESS_OR_ELSE_POLICY
		.createURL(a));
	return b
};
...
goog.html.SafeUrl.unwrapTrustedURL = function(a) {
	if (a instanceof goog.html.SafeUrl && a.constructor === goog.html.SafeUrl && a.SAFE_URL_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_ ===
		goog.html.SafeUrl.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_) return a.privateDoNotAccessOrElseSafeUrlWrappedValue_;
...
goog.html.SafeUrl.fromSmsUrl = function(a) {
	goog.string.internal.caseInsensitiveStartsWith(a, "sms:") && goog.html.SafeUrl.isSmsUrlBodyValid_(a) || (a = goog.html
...
goog.html.SafeUrl.sanitizeAssertUnchanged = function(a, b) {
	...
	goog.asserts.assert(goog.html.SAFE_URL_PATTERN_.test(a), "%s does not match the safe URL pattern", a) || (a = goog.html
		.SafeUrl.INNOCUOUS_STRING);
	return goog.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a)
};
...
goog.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse = function(a) {
	...
	b.privateDoNotAccessOrElseSafeUrlWrappedValue_ = goog.html.trustedtypes.PRIVATE_DO_NOT_ACCESS_OR_ELSE_POLICY ? goog.html
		.trustedtypes.PRIVATE_DO_NOT_ACCESS_OR_ELSE_POLICY.createURL(a) : a;
	return b
};
...
goog.html.SafeStyle.fromConstant = function(a) {
	...
	goog.asserts.assert(goog.string.internal.contains(a, ":"),
...
goog.html.SafeStyle.create = function(a) {
	...
	for (c in a) {
		...
		var d = a[c];
		null != d && (d = goog.isArray(d) ? goog.array.map(d, goog.html.SafeStyle.sanitizePropertyValue_).join(" ") : goog.html
			.SafeStyle.sanitizePropertyValue_(d), b += c + ":" + d + ";")
	}
	return b ? goog.html.SafeStyle.createSafeStyleSecurityPrivateDoNotAccessOrElse(b) : goog.html.SafeStyle.EMPTY
};
goog.html.SafeStyle.sanitizePropertyValue_ = function(a) {
	if (a instanceof goog.html.SafeUrl) return 'url("' + goog.html.SafeUrl.unwrap(a).replace(/</g, "%3c").replace(
		/[\\"]/g, "\\$&") + '")';
...
goog.html.SafeStyle.sanitizePropertyValueString_ = function(a) {
	...
	if (goog.html.SafeStyle.VALUE_RE_.test(b)) {
		...
		if (!goog.html.SafeStyle.hasBalancedQuotes_(a)) return goog.asserts.fail(
			"String value requires balanced quotes, got: " +
			a), goog.html.SafeStyle.INNOCUOUS_STRING;
		if (!goog.html.SafeStyle.hasBalancedSquareBrackets_(a)) return goog.asserts.fail(
				"String value requires balanced square brackets and one identifier per pair of brackets, got: " + a), goog.html.SafeStyle
			.INNOCUOUS_STRING
	} else return goog.asserts.fail("String value allows only " + goog.html.SafeStyle.VALUE_ALLOWED_CHARS_ +
		" and simple functions, got: " + a), goog.html.SafeStyle.INNOCUOUS_STRING;
...
goog.html.SafeStyleSheet.createRule = function(a, b) {
	...
	if (!goog.html.SafeStyleSheet.hasBalancedBrackets_(c)) throw Error("() and [] in selector must be balanced, got: " +
		a);
...
goog.html.SafeHtml.htmlEscapePreservingNewlines = function(a) {
	...
	return goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(goog.string.internal.newLineToBr(goog.html.SafeHtml
		.unwrap(a)), a.getDirection())
};
goog.html.SafeHtml.htmlEscapePreservingNewlinesAndSpaces = function(a) {
	if (a instanceof goog.html.SafeHtml) return a;
	a = goog.html.SafeHtml.htmlEscape(a);
	return goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(goog.string.internal.whitespaceEscape(goog.html
		.SafeHtml.unwrap(a)), a.getDirection())
};
...
goog.html.SafeHtml.createMetaRefresh = function(a, b) {
	...
	(goog.labs.userAgent.browser.isIE() || goog.labs.userAgent.browser.isEdge()) && goog.string.internal.contains(c, ";") &&
		(c = "'" + c.replace(/'/g, "%27") + "'");
...
goog.html.SafeHtml.join = function(a, b) {
	var c = goog.html.SafeHtml.htmlEscape(a),
		...
		e = [],
		f = function(a) {
			goog.isArray(a) ? goog.array.forEach(a, f) : (a = goog.html.SafeHtml.htmlEscape(a), e.push(goog.html.SafeHtml.unwrap(
					a)), a = a.getDirection(), d == goog.i18n.bidi.Dir.NEUTRAL ? d = a : a != goog.i18n.bidi.Dir.NEUTRAL && d != a &&
				(d = null))
		};
...
goog.html.SafeHtml.prototype.initSecurityPrivateDoNotAccessOrElse_ = function(a, b) {
	this.privateDoNotAccessOrElseSafeHtmlWrappedValue_ = goog.html.trustedtypes.PRIVATE_DO_NOT_ACCESS_OR_ELSE_POLICY ?
		goog.html.trustedtypes.PRIVATE_DO_NOT_ACCESS_OR_ELSE_POLICY.createHTML(a) : a;
	this.dir_ = b;
	return this
};
...
goog.html.uncheckedconversions.safeHtmlFromStringKnownToSatisfyTypeContract = function(a, b, c) {
	...
	goog.asserts.assert(!goog.string.internal.isEmptyOrWhitespace(goog.string.Const.unwrap(a)),
...
goog.dom.safe.setLinkHrefAndRel = function(a, b, c) {
	...
	a.rel = c;
	goog.string.internal.caseInsensitiveContains(c, "stylesheet") ? (goog.asserts.assert(b instanceof goog.html.TrustedResourceUrl,
			'URL must be TrustedResourceUrl because "rel" contains "stylesheet"'), a.href = goog.html.TrustedResourceUrl.unwrapTrustedURL(
			b)) : a.href = b instanceof goog.html.TrustedResourceUrl ? goog.html.TrustedResourceUrl.unwrapTrustedURL(b) : b instanceof goog
		.html.SafeUrl ? goog.html.SafeUrl.unwrapTrustedURL(b) :
...
goog.dom.safe.createImageFromBlob = function(a) {
	...
	goog.dom.safe.setImageSrc(a, goog.html.uncheckedconversions.safeUrlFromStringKnownToSatisfyTypeContract(goog.string.Const
...
goog.string.unescapeEntitiesUsingDom_ = function(a, b) {
	...
	return a.replace(goog.string.HTML_ENTITY_PATTERN_, function(a, b) {
		...
		e || (goog.dom.safe.setInnerHtml(d, goog.html.uncheckedconversions.safeHtmlFromStringKnownToSatisfyTypeContract(
...
goog.labs.userAgent.platform.getVersion = function() {
	...
	goog.labs.userAgent.platform.isWindows() ? (b = /Windows (?:NT|Phone) ([0-9.]+)/, b = (a = b.exec(a)) ? a[1] : "0.0") :
		goog.labs.userAgent.platform.isIos() ? (b = /(?:iPhone|iPod|iPad|CPU)\s+OS\s+(\S+)/, b = (a = b.exec(a)) && a[1].replace(
			...
			/_/g, ".") : "10") : goog.labs.userAgent.platform.isKaiOS() ? (b = /(?:KaiOS)\/(\S+)/i,
			b = (a = b.exec(a)) && a[1]) : goog.labs.userAgent.platform.isAndroid() ? (b = /Android\s+([^\);]+)(\)|;)/, b = (a =
			b.exec(a)) && a[1]) : goog.labs.userAgent.platform.isChromeOS() && (b = /(?:CrOS\s+(?:i686|x86_64)\s+([0-9.]+))/, b =
			(a = b.exec(a)) && a[1]);
	return b || ""
};
...
goog.userAgent.GO2PHONE = goog.userAgent.PLATFORM_KNOWN_ ? goog.userAgent.ASSUME_GO2PHONE : goog.labs.userAgent.platform
	.isGo2Phone();
...
goog.debug.normalizeErrorObject = function(a) {
	...
	return !c && a.lineNumber && a.fileName &&
		a.stack && a.message && a.name ? a : (b = a.message, null == b && (b = a.constructor && a.constructor instanceof Function ?
			'Unknown Error of type "' + (a.constructor.name ? a.constructor.name : goog.debug.getFunctionName(a.constructor)) +
...
goog.events.BrowserFeature = {
	...
	TOUCH_ENABLED: "ontouchstart" in goog.global || !!(goog.global.document && document.documentElement && "ontouchstart" in
		document.documentElement) || !(!goog.global.navigator || !goog.global.navigator.maxTouchPoints && !goog.global.navigator
		.msMaxTouchPoints),
	...
	PASSIVE_EVENTS: (0, $jscomp.scope.purify)(function() {
		...
		try {
			goog.global.addEventListener("test", goog.nullFunction, b), goog.global.removeEventListener("test", goog.nullFunction,
				b)
		} catch (c) {}
		return a
	})
...
goog.Disposable.prototype.dispose = function() {
	if (!this.disposed_ && (this.disposed_ = !0, this.disposeInternal(), goog.Disposable.MONITORING_MODE != goog.Disposable
		...
		if (goog.Disposable.MONITORING_MODE != goog.Disposable.MonitoringMode.OFF &&
			this.onDisposeCallbacks_ && 0 < this.onDisposeCallbacks_.length) throw Error(this +
...
goog.events.PointerFallbackEventType = {
	POINTERDOWN: goog.events.getPointerFallbackEventName_(goog.events.EventType.POINTERDOWN, goog.events.EventType.MSPOINTERDOWN,
		goog.events.EventType.MOUSEDOWN),
	POINTERUP: goog.events.getPointerFallbackEventName_(goog.events.EventType.POINTERUP, goog.events.EventType.MSPOINTERUP,
	...
	POINTERMOVE: goog.events.getPointerFallbackEventName_(goog.events.EventType.POINTERMOVE, goog.events.EventType.MSPOINTERMOVE,
		goog.events.EventType.MOUSEMOVE),
	POINTEROVER: goog.events.getPointerFallbackEventName_(goog.events.EventType.POINTEROVER, goog.events.EventType.MSPOINTEROVER,
		goog.events.EventType.MOUSEOVER),
	POINTEROUT: goog.events.getPointerFallbackEventName_(goog.events.EventType.POINTEROUT, goog.events.EventType.MSPOINTEROUT,
	...
	POINTERLEAVE: goog.events.getPointerFallbackEventName_(goog.events.EventType.POINTERLEAVE, goog.events.EventType.MSPOINTERLEAVE,
...
goog.events.BrowserEvent.prototype.init = function(a, b) {
	...
	d ? (this.clientX = void 0 !== d.clientX ? d.clientX : d.pageX, this.clientY = void 0 !==
		d.clientY ? d.clientY : d.pageY, this.screenX = d.screenX || 0, this.screenY = d.screenY || 0) : (goog.events.USE_LAYER_XY_AS_OFFSET_XY ?
		(this.offsetX = void 0 !== a.layerX ? a.layerX : a.offsetX, this.offsetY = void 0 !== a.layerY ? a.layerY : a.offsetY) :
		(this.offsetX = goog.userAgent.WEBKIT || void 0 !== a.offsetX ? a.offsetX : a.layerX, this.offsetY = goog.userAgent
			.WEBKIT || void 0 !== a.offsetY ? a.offsetY : a.layerY), this.clientX = void 0 !== a.clientX ? a.clientX : a.pageX,
		this.clientY = void 0 !== a.clientY ? a.clientY : a.pageY, this.screenX = a.screenX || 0, this.screenY =
		a.screenY || 0);
...
goog.events.BrowserEvent.prototype.isButton = function(a) {
	return goog.events.BrowserFeature.HAS_W3C_BUTTON ? this.event_.button == a : "click" == this.type ? a == goog.events.BrowserEvent
		.MouseButton.LEFT : !!(this.event_.button & goog.events.BrowserEvent.IE_BUTTON_MAP[a])
};
...
goog.events.listen_ = function(a, b, c, d, e, f) {
	...
	d.src = a;
	d.listener = c;
	if (a.addEventListener) goog.events.BrowserFeature.PASSIVE_EVENTS || (e = g), void 0 === e && (e = !1), a.addEventListener(
		b.toString(), d, e);
	else if (a.attachEvent) a.attachEvent(goog.events.getOnString_(b.toString()), d);
	else if (a.addListener && a.removeListener) goog.asserts.assert("change" === b,
		"MediaQueryList only has a change event"), a.addListener(d);
...
goog.events.listenOnce = function(a, b, c, d, e) {
	...
	c = goog.events.wrapListener(c);
	return goog.events.Listenable.isImplementedBy(a) ? (d = goog.isObject(d) ? !!d.capture : !!d, a.listenOnce(b, c, d, e)) :
	...
	if (!goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT) {
		...
		if (goog.events.CAPTURE_SIMULATION_MODE == goog.events.CaptureSimulationMode.ON) {
			if (!goog.events.isMarkedIeEvent_(c)) {
				...
				for (g = 0; !d.propagationStopped_ && g < c.length; g++) d.currentTarget = c[g], h = goog.events.fireListeners_(c[
					g], f, !1, d), e = e && h
			}
...
goog.math.longestCommonSubsequence = function(a, b, c, d) {
	...
	var l = [];
	h = e;
	for (k = f; 0 < h && 0 < k;) c(a[h - 1], b[k - 1]) ? (l.unshift(d(h - 1, k - 1)), h--, k--) : g[h - 1][k] > g[h][k -
		1
	] ? h-- : k--;
	return l
};
...
goog.dom.getElementsByTagNameAndClass_ = function(a, b, c, d) {
	...
	if (c) {
		d = {};
		for (f = e = 0; g = a[f]; f++) b = g.className, "function" == typeof b.split && goog.array.contains(b.split(/\s+/),
			c) && (d[e++] = g);
		d.length = e;
		return d
	}
...
goog.dom.getElementByTagNameAndClass_ = function(a, b, c, d) {
	...
	return goog.dom.canUseQuerySelector_(e) && (f || c) ? e.querySelector(f + (c ? "." + c : "")) : goog.dom.getElementsByTagNameAndClass_(
		a, b, c, d)[0] || null
};
...
goog.dom.safeHtmlToNode_ = function(a, b) {
	...
	goog.dom.BrowserFeature.INNER_HTML_NEEDS_SCOPED_ELEMENT ? (goog.dom.safe.setInnerHtml(c, goog.html.SafeHtml.concat(
		goog.html.SafeHtml.BR, b)), c.removeChild(goog.asserts.assert(c.firstChild))) : goog.dom.safe.setInnerHtml(c, b);
...
goog.dom.nativelySupportsFocus_ = function(a) {
	return "A" == a.tagName && a.hasAttribute("href") || "INPUT" == a.tagName || "TEXTAREA" == a.tagName || "SELECT" == a
		.tagName || "BUTTON" == a.tagName
};
...
goog.events.EventHandler.prototype.unlisten = function(a, b, c, d, e) {
	...
	else if (d = goog.isObject(d) ? !!d.capture : !!d, a = goog.events.getListener(a, b, c || this.handleEvent, d, e ||
			this.handler_ || this)) goog.events.unlistenByKey(a), delete this.keys_[a.key];
	return this
};
...
goog.events.KeyCodes.firesKeyPressEvent = function(a, b, c, d, e, f) {
	...
	if (!goog.userAgent.GECKO) {
		...
		var g = b == goog.events.KeyCodes.CTRL || b == goog.events.KeyCodes.ALT || goog.userAgent.MAC && b == goog.events.KeyCodes
			.META,
...
goog.events.KeyHandler.prototype.handleEvent = function(a) {
	...
	if (goog.userAgent.IE && a.type == goog.events.EventType.KEYPRESS) {
		...
		.OPERA && !goog.userAgent.WEBKIT ? (d = this.keyCode_,
			e = goog.events.KeyCodes.isCharacterKey(d) ? b.keyCode : 0) : (a.type == goog.events.EventType.KEYPRESS ? (goog.events
				.KeyHandler.SAVE_ALT_FOR_KEYPRESS_ && (c = this.altKey_), b.keyCode == b.charCode ? 32 > b.keyCode ? (d = b.keyCode,
					e = 0) : (d = this.keyCode_, e = b.charCode) : (d = b.keyCode || this.keyCode_, e = b.charCode || 0)) : (d = b.keyCode ||
				this.keyCode_, e = b.charCode || 0), goog.userAgent.MAC && e == goog.events.KeyCodes.QUESTION_MARK && d == goog.events
			.KeyCodes.WIN_KEY && (d = goog.events.KeyCodes.SLASH));
	...
	d ? 63232 <= d && d in goog.events.KeyHandler.safariKey_ ? f = goog.events.KeyHandler.safariKey_[d] : 25 == d && a.shiftKey &&
		(f = 9) : b.keyIdentifier && b.keyIdentifier in goog.events.KeyHandler.keyIdentifier_ && (f = goog.events.KeyHandler
			.keyIdentifier_[b.keyIdentifier]);
	goog.userAgent.GECKO && goog.events.KeyHandler.USES_KEYDOWN_ && a.type == goog.events.EventType.KEYPRESS && !goog.events
		.KeyCodes.firesKeyPressEvent(f, this.lastKey_, a.shiftKey, a.ctrlKey, c, a.metaKey) || (a = f == this.lastKey_, this
			.lastKey_ = f, b = new goog.events.KeyEvent(f,
...
goog.ui.Control.prototype.enableMouseEventHandling_ = function(a) {
	...
	a ? (c.listen(d, b.MOUSEDOWN, this.handleMouseDown).listen(d, [b.MOUSEUP, b.MOUSECANCEL], this.handleMouseUp).listen(
			d, goog.events.EventType.MOUSEOVER, this.handleMouseOver).listen(d, goog.events.EventType.MOUSEOUT, this.handleMouseOut),
		...
		goog.nullFunction && c.listen(d, goog.events.EventType.CONTEXTMENU, this.handleContextMenu), goog.userAgent.IE && (
			goog.userAgent.isVersionOrHigher(9) || c.listen(d, goog.events.EventType.DBLCLICK, this.handleDblClick), this.ieMouseEventSequenceSimulator_ ||
			(this.ieMouseEventSequenceSimulator_ = new goog.ui.Control.IeMouseEventSequenceSimulator_(this), this.registerDisposable(
				this.ieMouseEventSequenceSimulator_)))) : (c.unlisten(d, b.MOUSEDOWN, this.handleMouseDown).unlisten(d, [b.MOUSEUP,
			b.MOUSECANCEL
		], this.handleMouseUp).unlisten(d,
			goog.events.EventType.MOUSEOVER, this.handleMouseOver).unlisten(d, goog.events.EventType.MOUSEOUT, this.handleMouseOut),
...
goog.ui.Container.prototype.enterDocument = function() {
	...
	this.getHandler().listen(this, goog.ui.Component.EventType.ENTER, this.handleEnterItem).listen(this, goog.ui.Component
		.EventType.HIGHLIGHT, this.handleHighlightItem).listen(this,
		goog.ui.Component.EventType.UNHIGHLIGHT, this.handleUnHighlightItem).listen(this, goog.ui.Component.EventType.OPEN,
		this.handleOpenItem).listen(this, goog.ui.Component.EventType.CLOSE, this.handleCloseItem).listen(a, b.MOUSEDOWN,
		this.handleMouseDown).listen(goog.dom.getOwnerDocument(a), [b.MOUSEUP, b.MOUSECANCEL], this.handleDocumentMouseUp).listen(
		a, [b.MOUSEDOWN, b.MOUSEUP, b.MOUSECANCEL, goog.events.EventType.MOUSEOVER, goog.events.EventType.MOUSEOUT, goog.events
...
(function(a) {
	...
	Blockly.utils.userAgent.GECKO = b("Gecko") && !Blockly.utils.userAgent.WEBKIT && !Blockly.utils.userAgent.IE && !
	...
	Blockly.utils.userAgent.TABLET = Blockly.utils.userAgent.IPAD || Blockly.utils.userAgent.ANDROID && !b("Mobile") || b(
		"Silk");
	Blockly.utils.userAgent.MOBILE = !Blockly.utils.userAgent.TABLET && (Blockly.utils.userAgent.IPOD || Blockly.utils.userAgent
		.IPHONE || Blockly.utils.userAgent.ANDROID ||
		b("IEMobile"))
...
Blockly.utils.tokenizeInterpolation_ = function(a, b) {
	...
	for (var e = 0, f = [], g = null, h = 0; h < d.length; h++) {
		...
		0 == e ? "%" == k ? ((k = f.join("")) && c.push(k), f.length = 0, e = 1) : f.push(k) : 1 == e ? "%" == k ? (f.push(k),
			...
			e && ("" == k ? (f.splice(0, 0, "%{"), h--, e = 0) : "}" != k ? f.push(k) : (e = f.join(""), /[A-Z]\w*/i.test(e) ?
				(k = e.toUpperCase(), (k =
					Blockly.utils.string.startsWith(k, "BKY_") ? k.substring(4) : null) && k in Blockly.Msg ? (e = Blockly.Msg[k],
					"string" == typeof e ? Array.prototype.push.apply(c, Blockly.utils.tokenizeInterpolation_(e, b)) : b ? c.push(
						String(e)) : c.push(e)) : c.push("%{" + e + "}")) : c.push("%{" + e + "}"), e = f.length = 0))
	}(k = f.join("")) && c.push(k);
	d = [];
...
Blockly.Events.filter = function(a, b) {
	...
	for (var d = [], e = Object.create(null), f = 0, g; g = c[f]; f++)
		if (!g.isNull()) {
			...
			if (!k) e[h] = {
			...
			else if (g.type == Blockly.Events.MOVE && k.index == f - 1) l.newParentId = g.newParentId, l.newInputName = g.newInputName,
				...
				Blockly.Events.UI || "click" != g.element || "commentOpen" != l.element && "mutatorOpen" != l.element &&
				"warningOpen" != l.element) e[h] = {
				event: g,
				index: 1
			}, d.push(g)
...
Blockly.Events.Change.prototype.run = function(a) {
	...
	if (b) switch (b.mutator && b.mutator.setVisible(!1), a = a ? this.newValue : this.oldValue, this.element) {
		case "field":
			(b = b.getField(this.name)) ? (b.callValidator(a), b.setValue(a)) : console.warn("Can't set non-existent field: " +
				this.name);
			break;
		case "comment":
...
Blockly.Events.Move.prototype.fromJson = function(a) {
	...
	a.newCoordinate && (a = a.newCoordinate.split(","), this.newCoordinate = new Blockly.utils.Coordinate(parseFloat(a[0]),
		parseFloat(a[1])))
};
...
Blockly.Xml.blockToDom = function(a, b) {
	...
	e && (d = Blockly.utils.xml.createElement("comment"), d.appendChild(Blockly.utils.xml.createTextNode(e)), "object" ==
		typeof a.comment && (d.setAttribute("pinned", a.comment.isVisible()), e = a.comment.getBubbleSize(),
	...
	for (var f; f = a.inputList[e]; e++) {
		...
		if (f.type != Blockly.DUMMY_INPUT) {
			...
			f.type == Blockly.INPUT_VALUE ? g = Blockly.utils.xml.createElement("value") : f.type == Blockly.NEXT_STATEMENT &&
	...
	a.isEditable() || c.setAttribute("editable",
		!1);
	if (e = a.getNextBlock()) g = Blockly.utils.xml.createElement("next"), g.appendChild(Blockly.Xml.blockToDom(e, b)), c
		.appendChild(g);
	...
	try {
		for (var h = 0; h < e; h++) {
			...
			if ("block" == l || "shadow" == l && !Blockly.Events.recordUndo) {
				...
				if ("comment" == l) b.rendered ? Blockly.WorkspaceCommentSvg.fromXml(k, b, d) : Blockly.WorkspaceComment.fromXml(k,
					b);
				else if ("variables" == l) {
...
Blockly.Xml.domToBlockHeadless_ = function(a, b) {
	...
	for (var g; g = a.childNodes[e]; e++)
		if (g.nodeType != Blockly.utils.dom.Node.TEXT_NODE) {
			for (var h = f = null, k = 0, l; l = g.childNodes[k]; k++) l.nodeType == Blockly.utils.dom.Node.ELEMENT_NODE && (
				"block" == l.nodeName.toLowerCase() ? f = l : "shadow" == l.nodeName.toLowerCase() && (h = l));
			!f && h && (f = h);
...
Blockly.Events.CommentCreateDeleteHelper = function(a, b) {
	...
	} else(c = c.getCommentById(a.commentId)) ? c.dispose(!1, !1) : console.warn("Can't uncreate non-existent comment: " +
		a.commentId)
};
...
Blockly.Events.CommentMove.prototype.fromJson = function(a) {
	...
	a.newCoordinate && (a = a.newCoordinate.split(","), this.newCoordinate_ = new Blockly.utils.Coordinate(parseFloat(a[0]),
		parseFloat(a[1])))
};
...
Blockly.WorkspaceComment.prototype.dispose = function() {
	this.workspace && (Blockly.Events.isEnabled() && Blockly.Events.fire(new Blockly.Events.CommentDelete(this)), this.workspace
		.removeTopComment(this), this.workspace = null)
};
...
Blockly.WorkspaceComment.prototype.setContent = function(a) {
	this.content_ != a && (Blockly.Events.fire(new Blockly.Events.CommentChange(this, this.content_, a)), this.content_ =
		a)
};
...
Blockly.Workspace.prototype.sortObjects_ = function(a, b) {
	...
	return c.y + Blockly.Workspace.prototype.sortObjects_.offset * c.x - (d.y + Blockly.Workspace.prototype.sortObjects_.offset *
		d.x)
};
...
Blockly.Workspace.prototype.getBlocksByType = function(a, b) {
	...
	b && 1 < c.length && (this.sortObjects_.offset = Math.sign(Blockly.utils.math.toRadians(Blockly.Workspace.SCAN_ANGLE)),
...
Blockly.Bubble = function(a, b, c, d, e, f) {
	...
	this.rendered_ = !0;
	a.options.readOnly ||
		(Blockly.bindEventWithChecks_(this.bubbleBack_, "mousedown", this, this.bubbleMouseDown_), this.resizeGroup_ &&
...
Blockly.Bubble.prototype.getOverlap_ = function(a, b) {
	...
	return Math.max(0, Math.min(1, (Math.min(c + this.width_, b.viewLeft + b.viewWidth) - Math.max(c, b.viewLeft)) * (
		Math.min(d + this.height_, b.viewTop + b.viewHeight) - Math.max(d, b.viewTop)) / (this.width_ * this.height_)))
};
...
Blockly.Icon.prototype.renderIcon = function(a) {
	if (this.collapseHidden && this.block_.isCollapsed() || this.block_.isInsertionMarker()) return this.iconGroup_.setAttribute(
		"display", "none"), a;
...
Blockly.Comment.prototype.createEditor_ = function() {
	...
	Blockly.bindEventWithChecks_(b, "change", this, function(a) {
		this.text_ != b.value && (Blockly.Events.fire(new Blockly.Events.BlockChange(this.block_, "comment", null, this.text_,
...
Blockly.Comment.prototype.setVisible = function(a) {
	if (a != this.isVisible())
		if (Blockly.Events.fire(new Blockly.Events.Ui(this.block_, "commentOpen", !a, a)), !this.block_.isEditable() && !
			this.textarea_ || Blockly.utils.userAgent.IE) Blockly.Warning.prototype.setVisible.call(this, a);
		else {
			var b = this.getText(),
			...
			a ? (this.bubble_ = new Blockly.Bubble(this.block_.workspace, this.createEditor_(), this.block_.svgPath_, this.iconXY_,
					this.width_, this.height_), this.bubble_.setSvgId(this.block_.id), this.bubble_.registerResizeEvent(this.resizeBubble_
					.bind(this)),
...
Blockly.Comment.prototype.setText = function(a) {
	this.text_ != a && (Blockly.Events.fire(new Blockly.Events.BlockChange(this.block_, "comment", null, this.text_, a)),
		this.text_ = a);
...
Blockly.ConnectionDB.prototype.getNeighbours = function(a, b) {
	...
	for (var d = this.connections_, e = a.x_, f = a.y_, g = 0, h = d.length - 2, k = h; g < k;) d[k].y_ < f ? g = k : h =
		k, k = Math.floor((g + h) / 2);
	var l = [];
	h = g = k;
	if (d.length) {
		for (; 0 <= g && c(g);) g--;
...
Blockly.ConnectionDB.prototype.searchForClosest = function(a, b, c) {
	...
	c = null;
	for (var g = b, h, k = f - 1; 0 <= k && this.isInYRange_(k, a.y_, b);) h = this.connections_[k], a.isConnectionAllowed(
		h, g) && (c = h, g = h.distanceFrom(a)), k--;
	for (; f < this.connections_.length && this.isInYRange_(f, a.y_, b);) h = this.connections_[f], a.isConnectionAllowed(
...
Blockly.InsertionMarkerManager.prototype.dispose = function() {
	...
	Blockly.Events.disable();
	try {
		this.firstMarker_ && (this.firstMarker_.dispose(), this.firstMarker_ = null), this.lastMarker_ && (this.lastMarker_.dispose(),
...
Blockly.InsertionMarkerManager.prototype.shouldReplace_ = function() {
	...
	return b.type == Blockly.OUTPUT_VALUE ? !a.isConnected() || Blockly.Connection.lastConnectionInRow_(this.topBlock_, a
			.targetConnection.getSourceBlock()) ? !1 : !0 : b == b.sourceBlock_.getFirstStatementConnection() ? !1 : !this.topBlock_
		.nextConnection && b.type == Blockly.PREVIOUS_STATEMENT && a.isConnected() ? !0 : !1
};
...
Blockly.InsertionMarkerManager.prototype.highlightBlock_ = function() {
	...
	a.targetBlock() ? (this.highlightedBlock_ = a.targetBlock(), a.targetBlock().highlightForReplacement(!0)) : b.type ==
		Blockly.OUTPUT_VALUE && (this.highlightedBlock_ = a.sourceBlock_, a.sourceBlock_.highlightShapeForInput(a, !0));
...
Blockly.InsertionMarkerManager.prototype.disconnectMarker_ = function() {
	if (this.markerConnection_) {
		...
		!(a != c || d && d.targetConnection) || e ? a.targetBlock().unplug(!1) : a.type == Blockly.NEXT_STATEMENT && a != c ?
			(c = a.targetConnection, c.sourceBlock_.unplug(!1), d = d ? d.targetConnection : null, b.unplug(!0), d && d.connect(
				c)) : b.unplug(!0);
...
Blockly.BlockDragger.prototype.endBlockDrag = function(a, b) {
	...
	this.maybeDeleteBlock_() || (this.draggingBlock_.moveConnections_(c.x, c.y), this.draggingBlock_.setDragging(!1),
		this.fireMoveEvent_(), this.draggedConnectionManager_.wouldConnectBlock() ? this.draggedConnectionManager_.applyConnections() :
		this.draggingBlock_.render(), this.draggingBlock_.scheduleSnapAndBump());
	this.workspace_.setResizesEnabled(!0);
	if (c = this.workspace_.getToolbox()) d = this.draggingBlock_.isDeletable() ? "blocklyToolboxDelete" :
...
Blockly.WorkspaceCommentSvg.prototype.dispose = function() {
	this.workspace && (Blockly.selected == this && (this.unselect(), this.workspace.cancelCurrentGesture()), Blockly.Events
		.isEnabled() && Blockly.Events.fire(new Blockly.Events.CommentDelete(this)), Blockly.utils.dom.removeNode(this.svgGroup_),
		this.svgRect_ = this.svgGroup_ = null, this.disposeInternal_(), Blockly.Events.disable(), Blockly.WorkspaceCommentSvg
		.superClass_.dispose.call(this), Blockly.Events.enable())
};
Blockly.WorkspaceCommentSvg.prototype.initSvg = function() {
	...
	this.workspace.options.readOnly || this.eventsInit_ || (Blockly.bindEventWithChecks_(this.svgRectTarget_, "mousedown",
		this, this.pathMouseDown_), Blockly.bindEventWithChecks_(this.svgHandleTarget_, "mousedown", this, this.pathMouseDown_));
	this.eventsInit_ = !0;
	this.updateMovable();
...
Blockly.WorkspaceCommentSvg.prototype.showContextMenu_ = function(a) {
	if (!this.workspace.options.readOnly) {
		var b = [];
		this.isDeletable() && this.isMovable() && (b.push(Blockly.ContextMenu.commentDuplicateOption(this)), b.push(Blockly.ContextMenu
			.commentDeleteOption(this)));
...
Blockly.WorkspaceCommentSvg.prototype.moveDuringDrag = function(a, b) {
	a ? a.translateSurface(b.x, b.y) : (this.svgGroup_.translate_ = "translate(" + b.x + "," + b.y + ")", this.svgGroup_.setAttribute(
...
Blockly.WorkspaceCommentSvg.prototype.updateMovable = function() {
	this.isMovable() ? Blockly.utils.dom.addClass(this.svgGroup_, "blocklyDraggable") : Blockly.utils.dom.removeClass(
...
Blockly.WorkspaceCommentSvg.prototype.setDragging = function(a) {
	a ? (a = this.getSvgRoot(), a.translate_ = "", a.skew_ = "", Blockly.utils.dom.addClass(this.svgGroup_,
		"blocklyDragging")) : Blockly.utils.dom.removeClass(this.svgGroup_, "blocklyDragging")
};
...
Blockly.WorkspaceCommentSvg.prototype.setDeleteStyle = function(a) {
	a ? Blockly.utils.dom.addClass(this.svgGroup_, "blocklyDraggingDelete") : Blockly.utils.dom.removeClass(this.svgGroup_,
...
Blockly.BubbleDragger.prototype.updateCursorDuringBubbleDrag_ = function() {
	...
	this.wouldDeleteBubble_ ? (this.draggingBubble_.setDeleteStyle(!0), this.deleteArea_ == Blockly.DELETE_AREA_TRASH &&
		a && a.setOpen_(!0)) : (this.draggingBubble_.setDeleteStyle(!1), a && a.setOpen_(!1))
};
...
Blockly.Gesture = function(a, b) {
	this.startWorkspace_ = this.targetBlock_ = this.startBlock_ = this.startField_ = this.startBubble_ = this.currentDragDeltaXY_ =
...
Blockly.Gesture.prototype.updateIsDraggingFromFlyout_ = function() {
	return this.flyout_.isBlockCreatable_(this.targetBlock_) ? !this.flyout_.isScrollable() || this.flyout_.isDragTowardWorkspace(
		this.currentDragDeltaXY_) ? (this.startWorkspace_ = this.flyout_.targetWorkspace_, this.startWorkspace_.updateScreenCalculationsIfScrolled(),
		Blockly.Events.getGroup() || Blockly.Events.setGroup(!0), this.startBlock_ = null, this.targetBlock_ = this.flyout_
		.createBlock(this.targetBlock_), this.targetBlock_.select(), !0) : !1 : !1
};
...
Blockly.Gesture.prototype.doStart = function(a) {
	Blockly.utils.isTargetInput(a) ? this.cancel() : (this.hasStarted_ = !0, Blockly.blockAnimations.disconnectUiStop(),
		...
		this.startWorkspace_.markFocused(), this.mostRecentEvent_ = a, Blockly.hideChaff(!!this.flyout_), Blockly.Tooltip.block(),
		this.targetBlock_ && this.targetBlock_.select(), Blockly.utils.isRightButton(a) ? this.handleRightClick(a) : (
			"touchstart" !=
			a.type.toLowerCase() && "pointerdown" != a.type.toLowerCase() || "mouse" == a.pointerType || Blockly.longStart_(a,
				this), this.mouseDownXY_ = new Blockly.utils.Coordinate(a.clientX, a.clientY), this.healStack_ = a.altKey || a.ctrlKey ||
...
Blockly.Gesture.prototype.handleUp = function(a) {
	...
	this.isEnding_ ? console.log("Trying to end a gesture recursively.") : (this.isEnding_ = !0, this.isDraggingBubble_ ?
		...
		this.isBlockClick_() ? this.doBlockClick_() : this.isWorkspaceClick_() && this.doWorkspaceClick_(), a.preventDefault(),
...
Blockly.Gesture.prototype.handleRightClick = function(a) {
	this.targetBlock_ ? (this.bringBlockToFront_(), Blockly.hideChaff(this.flyout_), this.targetBlock_.showContextMenu_(a)) :
		this.startBubble_ ? this.startBubble_.showContextMenu_(a) : this.startWorkspace_ && !this.flyout_ && (Blockly.hideChaff(),
			this.startWorkspace_.showContextMenu_(a));
	a.preventDefault();
	a.stopPropagation();
	this.dispose()
};
...
Blockly.Trashcan = function(a) {
	...
	0 >= this.workspace_.options.maxTrashcanContents || (a = {
		...
		(a.toolboxPosition = this.workspace_.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT ? Blockly.TOOLBOX_AT_LEFT :
			Blockly.TOOLBOX_AT_RIGHT, this.flyout_ = new Blockly.VerticalFlyout(a)), this.workspace_.addChangeListener(this.onDelete_())
	)
};
...
Blockly.Trashcan.prototype.createDom = function() {
	...
	c.setAttributeNS(Blockly.utils.dom.XLINK_NS, "xlink:href", require('Assets/images/sprites.png'));
	...
	this.svgLid_.setAttributeNS(Blockly.utils.dom.XLINK_NS, "xlink:href",  require('Assets/images/sprites.png'));
...
Blockly.Trashcan.prototype.init = function(a) {
	0 < this.workspace_.options.maxTrashcanContents && (Blockly.utils.dom.insertAfter(this.flyout_.createDom("svg"), this
		.workspace_.getParentSvg()), this.flyout_.init(this.workspace_), this.flyout_.isBlockCreatable_ = function() {
		return !0
	});
...
Blockly.Trashcan.prototype.onDelete_ = function() {
	var a = this;
	return function(b) {
		0 >= a.workspace_.options.maxTrashcanContents || b.type != Blockly.Events.BLOCK_DELETE || "shadow" == b.oldXml.tagName
			.toLowerCase() || (b = a.cleanBlockXML_(b.oldXml), -1 == a.contents_.indexOf(b) && (a.contents_.unshift(b), a.contents_
				.length > a.workspace_.options.maxTrashcanContents && a.contents_.splice(a.workspace_.options.maxTrashcanContents,
					a.contents_.length - a.workspace_.options.maxTrashcanContents), a.hasBlocks_ = !0, a.minOpenness_ = a.HAS_BLOCKS_LID_ANGLE,
	...
	var d = function(e) {
		...
		Blockly.Variables.promptName(f, e, function(e) {
			if (e) {
				...
				f ? (f = Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE.replace("%1", e.toLowerCase()).replace("%2", f.type),
...
Blockly.WorkspaceAudio.prototype.play = function(a, b) {
	...
	if (c) {
		var d = new Date;
		null != this.lastSound_ && d - this.lastSound_ < Blockly.SOUND_LIMIT || (this.lastSound_ = d, c = Blockly.utils.userAgent
			.IPAD || Blockly.utils.userAgent.ANDROID ? c : c.cloneNode(), c.volume = void 0 === b ? 1 : b, c.play())
...
Blockly.WorkspaceCommentSvg.prototype.render = function() {
	if (!this.rendered_) {
		...
		this.isDeletable() && (Blockly.bindEventWithChecks_(this.deleteGroup_, "mousedown", this, this.deleteMouseDown_),
			Blockly.bindEventWithChecks_(this.deleteGroup_, "mouseout", this, this.deleteMouseOut_), Blockly.bindEventWithChecks_(
				this.deleteGroup_,
...
Blockly.WorkspaceCommentSvg.prototype.resizeMouseDown_ = function(a) {
	...
	Blockly.utils.isRightButton(a) || (this.workspace.startDrag(a, new Blockly.utils.Coordinate(this.workspace.RTL ? -
		this.width_ : this.width_, this.height_)), this.onMouseUpWrapper_ = Blockly.bindEventWithChecks_(document,
		"mouseup", this, this.resizeMouseUp_), this.onMouseMoveWrapper_ = Blockly.bindEventWithChecks_(document,
...
Blockly.WorkspaceCommentSvg.prototype.setSize_ = function(a, b) {
	...
	this.resizeGroup_ && (this.RTL ? (this.resizeGroup_.setAttribute("transform", "translate(" + (-a + c) + "," + (b - c) +
		") scale(-1 1)"), this.deleteGroup_.setAttribute("transform", "translate(" + (-a + c) + "," + -c +
		") scale(-1 1)")) : (this.resizeGroup_.setAttribute("transform", "translate(" + (a - c) + "," + (b - c) + ")"),
		this.deleteGroup_.setAttribute("transform", "translate(" + (a - c) + "," + -c + ")")));
	this.resizeComment_()
};
...
Blockly.WorkspaceCommentSvg.prototype.setFocus = function() {
	...
	this.focused_ = !0;
	setTimeout(function() {
		a.disposed_ || (a.textarea_.focus(), a.addFocus(), Blockly.utils.dom.addClass(a.svgRectTarget_,
			"blocklyCommentTargetFocused"), Blockly.utils.dom.addClass(a.svgHandleTarget_,
...
Blockly.WorkspaceCommentSvg.prototype.blurFocus = function() {
	...
	this.focused_ = !1;
	setTimeout(function() {
		a.disposed_ || (a.textarea_.blur(), a.removeFocus(), Blockly.utils.dom.removeClass(a.svgRectTarget_,
			"blocklyCommentTargetFocused"), Blockly.utils.dom.removeClass(a.svgHandleTarget_,
			"blocklyCommentHandleTargetFocused"))
	}, 0)
};
...
Blockly.WorkspaceSvg.prototype.highlightBlock = function(a, b) {
	...
	if (d = a ? this.getBlockById(a) : null)(c = void 0 === b || b) ? -1 == this.highlightedBlocks_.indexOf(d) && this.highlightedBlocks_
		.push(d) : Blockly.utils.arrayRemove(this.highlightedBlocks_, d), d.setHighlighted(c)
};
...
Blockly.WorkspaceSvg.prototype.isContentBounded = function() {
	return this.options.moveOptions && this.options.moveOptions.scrollbars || this.options.moveOptions && this.options.moveOptions
		...
		.controls || this.options.zoomOptions && this.options.zoomOptions.wheel
};
...
Blockly.WorkspaceSvg.prototype.zoomToFit = function() {
	if (this.isMovable()) {
		...
		var c = this.getBlocksBoundingBox(),
			d = c.right - c.left;
		c = c.bottom - c.top;
		d && (this.flyout_ && (this.horizontalLayout ? (a += this.flyout_.height_, c += this.flyout_.height_ / this.scale) :
...
Blockly.Mutator.prototype.setVisible = function(a) {
	if (a != this.isVisible())
		if (Blockly.Events.fire(new Blockly.Events.Ui(this.block_, "mutatorOpen", !a, a)), a) {
			...
			this.workspace_.flyout_ ? (a = 2 * this.workspace_.flyout_.CORNER_RADIUS, b = this.workspace_.getFlyout().getWidth() +
				a) : b = a = 16;
			this.block_.RTL && (b = -b);
	...
	if (null !== a) {
		...
		if (!(a instanceof Error)) {
			...
			b !== a && (this.sourceBlock_ && Blockly.Events.isEnabled() && Blockly.Events.fire(new Blockly.Events.BlockChange(
				this.sourceBlock_, "field", this.name, b, a)), this.doValueUpdate_(a), this.isDirty_ && this.forceRerender())
		}
	}
};
...
Blockly.Block = function(a, b, c) {
	if ("undefined" !== typeof Blockly.Generator.prototype[b]) throw Error('Block prototypeName "' + b +
...
Blockly.Block.prototype.dispose = function(a) {
	if (this.workspace) {
		...
		Blockly.Events.disable();
		try {
			this.workspace && (this.workspace.removeTopBlock(this), this.workspace.removeTypedBlock(this), delete this.workspace
				.blockDB_[this.id], this.workspace = null);
...
Blockly.Block.prototype.unplugFromRow_ = function(a) {
	...
	b && a && (a = this.getOnlyValueConnection_()) && a.isConnected() && !a.targetBlock().isShadow() && (a = a.targetConnection,
...
Blockly.Block.prototype.unplugFromStack_ = function(a) {
	...
	a && c && !c.isShadow() && (a = this.nextConnection.targetConnection, a.disconnect(), b && b.checkType_(a) && b.connect(
		a))
};
...
Blockly.Block.prototype.setConnectionsHidden = function(a) {
	if (!a && this.isCollapsed()) {
		if (this.outputConnection && this.outputConnection.setHidden(a), this.previousConnection && this.previousConnection.setHidden(
				a), this.nextConnection) {
...
Blockly.Block.prototype.setStyle = function(a) {
	...
	b = b.getBlockStyle(a);
	this.styleName_ = a;
	if (b) this.colourSecondary_ = b.colourSecondary, this.colourTertiary_ = b.colourTertiary, this.hat = b.hat, this.setColour(
		b.colourPrimary);
...
Blockly.Block.prototype.setCommentText = function(a) {
	this.comment != a && (Blockly.Events.fire(new Blockly.Events.BlockChange(this, "comment", null, this.comment, a || "")),
		this.comment = a)
};
...
Blockly.BlockSvg.prototype.setParent = function(a) {
	...
	if (a != b) {
		...
		if (!this.workspace.isClearing && c) {
			...
			a ? (a.getSvgRoot().appendChild(c), a = this.getRelativeToSurfaceXY(), this.moveConnections_(a.x - d.x, a.y - d.y)) :
...
Blockly.BlockSvg.prototype.moveDuringDrag = function(a) {
	this.useDragSurface_ ? this.workspace.blockDragSurface_.translateSurface(a.x, a.y) : (this.svgGroup_.translate_ =
...
Blockly.BlockSvg.prototype.setBorderColour_ = function() {
	...
	a.colourBorder ? (this.svgPathLight_.style.display = "none", this.svgPathDark_.style.display = "none", this.svgPath_.setAttribute(
		"stroke", a.colourBorder)) : (this.svgPathLight_.style.display = "", this.svgPathDark_.style.display = "", this.svgPath_
		.setAttribute("stroke", "none"), this.svgPathLight_.setAttribute("stroke", a.colourLight), this.svgPathDark_.setAttribute(
			"fill", a.colourDark))
};
...
Blockly.BlockSvg.prototype.updateDisabled = function() {
	!this.isEnabled() || this.getInheritedDisabled() ? Blockly.utils.dom.addClass(this.svgGroup_, "blocklyDisabled") &&
		this.svgPath_.setAttribute("fill", "url(#" + this.workspace.options.disabledPatternId + ")") : Blockly.utils.dom.removeClass(
			this.svgGroup_, "blocklyDisabled") && this.updateColour();
...
Blockly.BlockSvg.prototype.setWarningText = function(a, b) {
	...
	if (this.workspace.isDragging()) {
		...
		"string" == typeof a ? (this.warning || (this.warning = new Blockly.Warning(this), d = !0), this.warning.setText(a,
			c)) : this.warning && !c ? (this.warning.dispose(), d = !0) : this.warning && (d = this.warning.getText(), this.warning
			.setText("", c), (f = this.warning.getText()) || this.warning.dispose(), d = d != f);
		d && this.rendered &&
...
Blockly.BlockSvg.prototype.setHighlighted = function(a) {
	this.rendered && (a ? (this.svgPath_.setAttribute("filter", "url(#" + this.workspace.options.embossFilterId + ")"),
		this.svgPathLight_.style.display = "none") : (this.svgPath_.setAttribute("filter", "none"), this.svgPathLight_.style
		.display = "inline"))
};
	...
	for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, l = this.getInputsInline() && !this.isCollapsed(), n = 0,
		...
		if (m.isVisible()) {
			...
			p.type != Blockly.BlockSvg.INLINE && (p.type == Blockly.NEXT_STATEMENT ?
				(g = !0, e = Math.max(e, m.fieldWidth)) : (p.type == Blockly.INPUT_VALUE ? f = !0 : p.type == Blockly.DUMMY_INPUT &&
...
Blockly.BlockSvg.prototype.renderDraw_ = function(a, b) {
	...
	if (this.outputConnection) this.squareBottomLeftCorner_ = this.squareTopLeftCorner_ = !0;
		...
		this.previousConnection ? (c = this.previousConnection.targetBlock()) && c.getNextBlock() == this && (this.squareTopLeftCorner_ = !
			0) : c && (this.startHat_ = this.squareTopLeftCorner_ = !0, this.height += Blockly.BlockSvg.START_HAT_HEIGHT,
...
Blockly.BlockSvg.prototype.renderDrawTop_ = function(a, b) {
	var c = a.steps,
		d = a.highlightSteps;
	this.squareTopLeftCorner_ ? (c.push("m 0,0"), d.push("m 0.5,0.5"), this.startHat_ && (c.push(Blockly.BlockSvg.START_HAT_PATH),
		d.push(this.RTL ? Blockly.BlockSvg.START_HAT_HIGHLIGHT_RTL : Blockly.BlockSvg.START_HAT_HIGHLIGHT_LTR))) : (c.push(
	...
	this.previousConnection && (c.push("H", Blockly.BlockSvg.NOTCH_WIDTH - 15), d.push("H", Blockly.BlockSvg.NOTCH_WIDTH -
			15), c.push(Blockly.BlockSvg.NOTCH_PATH_LEFT), d.push(Blockly.BlockSvg.NOTCH_PATH_LEFT_HIGHLIGHT), this.previousConnection
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function(a, b, c) {
	for (var d = {
			...
			x: 0,
			y: 0
		}, f = 0, g; g = b[f]; f++) d.x = Blockly.BlockSvg.SEP_SPACE_X, 0 == f && (d.x += this.RTL ? -c : c), a.highlightSteps
		.push("M", b.rightEdge - .5 + "," + (d.y + .5)), this.isCollapsed() ? this.renderJaggedEdge_(a, g, d) : g.type ==
		Blockly.BlockSvg.INLINE ? this.renderInlineRow_(a, g, d, e, b.rightEdge) : g.type == Blockly.INPUT_VALUE ? this.renderExternalValueInput_(
			a, g, d, e, b.rightEdge) : g.type == Blockly.DUMMY_INPUT ? this.renderDummyInput_(a, g, d, b.rightEdge, b.hasValue) :
		g.type == Blockly.NEXT_STATEMENT && this.renderStatementInput_(a, g, d, e, b, f), d.y += g.height;
	b.length || (d.y = Blockly.BlockSvg.MIN_BLOCK_Y, a.steps.push("V", d.y), this.RTL && a.highlightSteps.push("V", d.y -
		1));
	return d.y
};
Blockly.BlockSvg.prototype.renderDrawBottom_ = function(a, b) {
	var c = a.steps,
		d = a.highlightSteps;
	this.height += b + 1;
	this.nextConnection && (c.push("H", Blockly.BlockSvg.NOTCH_WIDTH + (this.RTL ? .5 : -.5) + " " + Blockly.BlockSvg.NOTCH_PATH_RIGHT),
		this.nextConnection.setOffsetInBlock(this.RTL ? -Blockly.BlockSvg.NOTCH_WIDTH : Blockly.BlockSvg.NOTCH_WIDTH, b + 1),
		this.height += 4);
	this.squareBottomLeftCorner_ ? (c.push("H 0"), this.RTL || d.push("M", "0.5," + (b - .5))) : (c.push("H", Blockly.BlockSvg
		.CORNER_RADIUS), c.push("a", Blockly.BlockSvg.CORNER_RADIUS +
		"," + Blockly.BlockSvg.CORNER_RADIUS + " 0 0,1 -" + Blockly.BlockSvg.CORNER_RADIUS + ",-" + Blockly.BlockSvg.CORNER_RADIUS
	), this.RTL || (d.push("M", Blockly.BlockSvg.DISTANCE_45_INSIDE + "," + (b - Blockly.BlockSvg.DISTANCE_45_INSIDE)),
		d.push("A", Blockly.BlockSvg.CORNER_RADIUS - .5 + "," + (Blockly.BlockSvg.CORNER_RADIUS - .5) + " 0 0,1 0.5," + (b -
			Blockly.BlockSvg.CORNER_RADIUS))))
};
Blockly.BlockSvg.prototype.renderDrawLeft_ = function(a) {
	var b = a.steps;
	a = a.highlightSteps;
	this.outputConnection ? (this.outputConnection.setOffsetInBlock(0, 0), b.push("V", Blockly.BlockSvg.TAB_HEIGHT), b.push(
			"c 0,-10 -" + Blockly.BlockSvg.TAB_WIDTH + ",8 -" + Blockly.BlockSvg.TAB_WIDTH + ",-7.5 s " + Blockly.BlockSvg.TAB_WIDTH +
			",2.5 " + Blockly.BlockSvg.TAB_WIDTH + ",-7.5"), this.RTL ? (a.push("M", -.25 * Blockly.BlockSvg.TAB_WIDTH +
			",8.4"), a.push("l", -.45 * Blockly.BlockSvg.TAB_WIDTH + ",-2.1")) : (a.push("V", Blockly.BlockSvg.TAB_HEIGHT -
			1.5), a.push("m", -.92 * Blockly.BlockSvg.TAB_WIDTH + ",-0.5 q " + -.19 * Blockly.BlockSvg.TAB_WIDTH +
			",-5.5 0,-11"), a.push("m", .92 * Blockly.BlockSvg.TAB_WIDTH + ",1 V 0.5 H 1")), this.width += Blockly.BlockSvg.TAB_WIDTH) :
		this.RTL || (this.squareTopLeftCorner_ ? a.push("V", .5) : a.push("V", Blockly.BlockSvg.CORNER_RADIUS));
	b.push("z")
};
...
Blockly.BlockSvg.prototype.renderInlineRow_ = function(a, b, c, d, e) {
	...
	for (var k = 0, l; l = b[k]; k++) {
		...
		l.type == Blockly.INPUT_VALUE && (f.push("M", c.x - Blockly.BlockSvg.SEP_SPACE_X + "," + (c.y + Blockly.BlockSvg.INLINE_PADDING_Y)),
			f.push("h", Blockly.BlockSvg.TAB_WIDTH -
				2 - l.renderWidth), f.push(Blockly.BlockSvg.TAB_PATH_DOWN), f.push("v", l.renderHeight + 1 - Blockly.BlockSvg.TAB_HEIGHT),
			f.push("h", l.renderWidth + 2 - Blockly.BlockSvg.TAB_WIDTH), f.push("z"), this.RTL ? (g.push("M", c.x - Blockly.BlockSvg
				.SEP_SPACE_X - 2.5 + Blockly.BlockSvg.TAB_WIDTH - l.renderWidth + "," + (c.y + Blockly.BlockSvg.INLINE_PADDING_Y +
					.5)), g.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL), g.push("v", l.renderHeight - Blockly.BlockSvg.TAB_HEIGHT +
				2.5), g.push("h", l.renderWidth - Blockly.BlockSvg.TAB_WIDTH + 2)) : (g.push("M",
				c.x - Blockly.BlockSvg.SEP_SPACE_X + .5 + "," + (c.y + Blockly.BlockSvg.INLINE_PADDING_Y + .5)), g.push("v", l.renderHeight +
				1), g.push("h", Blockly.BlockSvg.TAB_WIDTH - 2 - l.renderWidth), g.push("M", c.x - l.renderWidth - Blockly.BlockSvg
				.SEP_SPACE_X + .9 + "," + (c.y + Blockly.BlockSvg.INLINE_PADDING_Y + Blockly.BlockSvg.TAB_HEIGHT - .7)), g.push(
				"l", .46 * Blockly.BlockSvg.TAB_WIDTH + ",-2.1")), d.x = this.RTL ? -c.x - Blockly.BlockSvg.TAB_WIDTH + Blockly.BlockSvg
			.SEP_SPACE_X + l.renderWidth + 1 : c.x + Blockly.BlockSvg.TAB_WIDTH - Blockly.BlockSvg.SEP_SPACE_X -
...
Blockly.BlockSvg.prototype.renderExternalValueInput_ = function(a, b, c, d, e) {
	...
	this.RTL ? (a.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL),
		a.push("v", b + .5)) : (a.push("M", e - 5 + "," + (c.y + Blockly.BlockSvg.TAB_HEIGHT - .7)), a.push("l", .46 *
		Blockly.BlockSvg.TAB_WIDTH + ",-2.1"));
	d.x = this.RTL ? -e - 1 : e + 1;
	g.connection.setOffsetInBlock(d.x, c.y);
	g.connection.isConnected() && (this.width = Math.max(this.width, e + g.connection.targetBlock().getHeightWidth().width -
...
Blockly.BlockSvg.prototype.renderDummyInput_ = function(a, b, c, d, e) {
	...
	var g = b[0],
		h = c.x;
	c = c.y;
	g.align != Blockly.ALIGN_LEFT && (d = d - g.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X, e && (d -= Blockly.BlockSvg
		.TAB_WIDTH), g.align == Blockly.ALIGN_RIGHT ? h += d : g.align == Blockly.ALIGN_CENTRE && (h += d / 2));
...
Blockly.BlockSvg.prototype.renderStatementInput_ = function(a, b, c, d, e, f) {
	...
	a = a.highlightSteps;
	var h = b[0];
	0 == f && (g.push("v", Blockly.BlockSvg.SEP_SPACE_Y), this.RTL && a.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1), c.y +=
	...
	this.RTL ? (a.push("M", c.x - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + "," + (c.y +
			Blockly.BlockSvg.DISTANCE_45_OUTSIDE)), a.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER_HIGHLIGHT_RTL), a.push("v",
			b.height - 2 * Blockly.BlockSvg.CORNER_RADIUS), a.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_RTL)) :
	...
	h.connection.isConnected() && (this.width = Math.max(this.width, e.statementEdge + h.connection.targetBlock().getHeightWidth()
		.width));
...
Blockly.BlockSvg.prototype.highlightForReplacement = function(a) {
	a ? Blockly.utils.dom.addClass(this.svgGroup_, "blocklyReplaceable") : Blockly.utils.dom.removeClass(this.svgGroup_,
		"blocklyReplaceable")
};
...
Blockly.DropDownDiv.show = function(a, b, c, d, e, f) {
	...
	Blockly.DropDownDiv.arrow_.setAttribute("class", a.arrowAtTop ? "blocklyDropDownArrow arrowTop" :
...
Blockly.DropDownDiv.repositionForWindowResize = function() {
	if (Blockly.DropDownDiv.owner_) {
		...
		c *= b;
		d *= b;
		a = Blockly.DropDownDiv.positionToField_ ? Blockly.DropDownDiv.owner_.fieldGroup_.getBoundingClientRect() : a.getSvgRoot()
...
Blockly.FieldTextInput.prototype.render_ = function() {
	...
	this.isBeingEdited_ && (this.resizeEditor_(), this.isTextValid_ ? Blockly.utils.dom.removeClass(this.htmlInput_,
		"blocklyInvalidInput") : Blockly.utils.dom.addClass(this.htmlInput_, "blocklyInvalidInput"))
};
...
Blockly.FieldTextInput.prototype.onHtmlInputKeyDown_ = function(a) {
	13 == a.keyCode ? Blockly.WidgetDiv.hide() : 27 == a.keyCode ? (this.htmlInput_.value = this.htmlInput_.defaultValue,
		Blockly.WidgetDiv.hide()) : 9 == a.keyCode && (Blockly.WidgetDiv.hide(), this.sourceBlock_.tab(this, !a.shiftKey),
		a.preventDefault())
};
Blockly.FieldTextInput.prototype.onHtmlInputChange_ = function(a) {
	a = this.htmlInput_.value;
	a !== this.htmlInput_.oldValue_ && (this.htmlInput_.oldValue_ = a, Blockly.Events.setGroup(!0), this.setValue(a),
		this.text_ = this.htmlInput_.value, this.forceRerender(), Blockly.Events.setGroup(!1))
};
...
Blockly.FieldAngle.prototype.showEditor_ = function() {
	Blockly.FieldAngle.superClass_.showEditor_.call(this, Blockly.utils.userAgent.MOBILE || Blockly.utils.userAgent.ANDROID ||
...
Blockly.FieldAngle.prototype.onMouseMove = function(a) {
	...
	a = Math.atan(-b / c);
	isNaN(a) || (a = Blockly.utils.math.toDegrees(a), 0 > c ? a += 180 : 0 < b && (a += 360), a = Blockly.FieldAngle.CLOCKWISE ?
		Blockly.FieldAngle.OFFSET + 360 - a : 360 - (Blockly.FieldAngle.OFFSET - a), 360 < a && (a -= 360), Blockly.FieldAngle
		.ROUND && (a = Math.round(a / Blockly.FieldAngle.ROUND) * Blockly.FieldAngle.ROUND), a > Blockly.FieldAngle.WRAP &&
...
Blockly.utils.colour.parse = function(a) {
	...
	return c && (a = Number(c[1]), b = Number(c[2]), c = Number(c[3]), 0 <= a && 256 > a && 0 <= b && 256 > b && 0 <= c &&
		256 > c) ? Blockly.utils.colour.rgbToHex(a, b, c) : null
};
...
Blockly.FieldDropdown.prototype.doValueUpdate_ = function(a) {
	...
	a = this.getOptions();
	for (var b = 0, c; c = a[b]; b++) c[1] == this.value_ && (c = c[0], "object" == typeof c ? (this.imageJson_ = c, this
		.text_ = c.alt) : (this.imageJson_ = null, this.text_ = c))
};
Blockly.FieldDropdown.prototype.updateColour = function() {
	this.sourceBlock_ && this.arrow_ && (this.sourceBlock_.isShadow() ? this.arrow_.style.fill = this.sourceBlock_.getColourShadow() :
...
Blockly.FieldDropdown.prototype.renderSelectedImage_ = function() {
	...
	this.sourceBlock_.RTL ? (this.imageElement_.setAttribute("x",
		a), this.textElement_.setAttribute("x", -1)) : (this.textElement_.setAttribute("text-anchor", "end"), this.textElement_
		.setAttribute("x", this.size_.width + 1))
};
...
Blockly.FieldDropdown.validateOptions_ = function(a) {
	...
	for (var b = !1, c = 0; c < a.length; ++c) {
		...
		Array.isArray(d) ? "string" != typeof d[1] ? (b = !0, console.error("Invalid option[" + c +
				"]: Each FieldDropdown option id must be a string. Found " + d[1] + " in: ", d)) : "string" != typeof d[0] &&
			"string" != typeof d[0].src && (b = !0, console.error("Invalid option[" + c +
				"]: Each FieldDropdown option must have a string label or image description. Found" +
				d[0] + " in: ", d)) : (b = !0, console.error("Invalid option[" + c +
				"]: Each FieldDropdown option must be an array. Found: ", d))
	}
...
Blockly.FieldImage = function(a, b, c, d, e, f) {
	...
	if (0 >= this.height_ || 0 >= this.width_) throw Error(
		...
		if (f.tagName) switch (f.tagName.toUpperCase()) {
			...
			case "BUTTON":
				g = "LABEL" == f.tagName.toUpperCase(), f = new Blockly.FlyoutButton(this.workspace_,
					this.targetWorkspace_, f, g), b.push({
					type: "button",
					button: f
				}), c.push(d)
		}
...
Blockly.VerticalFlyout.prototype.getClientRect = function() {
	...
	Blockly.utils.userAgent.GECKO && this.targetWorkspace_ && this.targetWorkspace_.isMutator && (a = this.targetWorkspace_
		.svgGroup_.getBoundingClientRect().x, 10 > Math.abs(a - b) && (b += this.leftEdge_ * this.targetWorkspace_.options.parentWorkspace
			.scale));
...
Blockly.VerticalFlyout.prototype.reflowInternal_ = function() {
	...
	if (this.width_ != a) {
		for (c = 0; d = b[c]; c++) this.RTL && (e = d.getRelativeToSurfaceXY().x,
			d.moveBy(a / this.workspace_.scale - this.MARGIN - Blockly.BlockSvg.TAB_WIDTH - e, 0)), d.flyoutRect_ && this.moveRectToBlock_(
			d.flyoutRect_, d);
		if (this.RTL)
			for (c = 0; d = this.buttons_[c]; c++) b = d.getPosition().y, d.moveTo(a / this.workspace_.scale - d.width - this.MARGIN -
				Blockly.BlockSvg.TAB_WIDTH, b);
		this.width_ = a;
		this.position()
	}
};
...
Blockly.Toolbox.prototype.setColourFromStyle_ = function(a, b, c) {
	if ((b.styleName = a) && Blockly.getTheme()) {
		...
		d && d.colour ? this.setColour_(d.colour, b, c) : console.warn('Style "' + a +
...
Blockly.Css.inject = function(a, b) {
	if (!Blockly.Css.injected_) {
		...
		a && (c += Blockly.Css.CONTENT.join("\n"), Blockly.Css.CONTENT = null, Blockly.FieldDate && (c += Blockly.FieldDate.CSS
			.join("\n")));
...
Blockly.Css.CONTENT = [".blocklySvg {", "background-color: #fff;", "outline: none;", "overflow: hidden;",
	...
	"position: absolute;", "z-index: 100000;", "}", ".blocklyDropDownDiv {", "position: fixed;", "left: 0;", "top: 0;",
	"z-index: 1000;", "display: none;", "border: 1px solid;", "border-radius: 2px;", "padding: 4px;",
	"-webkit-user-select: none;", "}", ".blocklyDropDownContent {", "max-height: 300px;", "overflow: auto;",
	"overflow-x: hidden;", "}", ".blocklyDropDownArrow {", "position: absolute;", "left: 0;", "top: 0;",
	"width: 16px;", "height: 16px;", "z-index: -1;", "background-color: inherit;", "border-color: inherit;", "}",
	...
	".arrowTop {", "border-top: 1px solid;", "border-left: 1px solid;", "border-top-left-radius: 4px;",
	"border-color: inherit;", "}", ".arrowBottom {", "border-bottom: 1px solid;", "border-right: 1px solid;",
	"border-bottom-right-radius: 4px;", "border-color: inherit;", "}", ".blocklyResizeSE {", "cursor: se-resize;",
	"fill: #aaa;", "}", ".blocklyResizeSW {", "cursor: sw-resize;", "fill: #aaa;", "}", ".blocklyResizeLine {",
	"stroke: #515A5A;", "stroke-width: 1;", "}", ".blocklyHighlightedConnectionPath {", "fill: none;", "stroke: #fc3;",
	"stroke-width: 4px;", "}", ".blocklyPathLight {", "fill: none;", "stroke-linecap: round;", "stroke-width: 1;", "}",
	...
	"display: none;", "}", ".blocklyDisabled>.blocklyPath {", "fill-opacity: .5;", "stroke-opacity: .5;", "}",
	...
	".blocklyReplaceable .blocklyPath {", "fill-opacity: 0.5;", "}", ".blocklyReplaceable .blocklyPathLight,",
	".blocklyReplaceable .blocklyPathDark {",
	"display: none;", "}", ".blocklyText {", "cursor: default;", "fill: #fff;", "font-family: sans-serif;",
	"font-size: 11pt;", "}", ".blocklyNonEditableText>text {", "pointer-events: none;", "}",
	...
	"}", ".blocklyFlyout {", "position: absolute;",
	"z-index: 20;", "}", ".blocklyFlyoutButton {", "fill: #888;", "cursor: default;", "}", ".blocklyFlyoutButtonShadow {",
	"fill: #666;", "}", ".blocklyFlyoutButton:hover {", "fill: #aaa;", "}", ".blocklyFlyoutLabel {", "cursor: default;",
	...
	"-ms-user-select: none;", "-webkit-user-select: none;", "cursor: inherit;", "}", ".blocklyHidden {",
	"display: none;", "}", ".blocklyFieldDropdown:not(.blocklyHidden) {", "display: block;", "}", ".blocklyIconGroup {",
	"cursor: default;", "}", ".blocklyIconGroup:not(:hover),", ".blocklyIconGroupReadonly {", "opacity: .6;", "}",
	".blocklyIconShape {", "fill: #00f;", "stroke: #fff;", "stroke-width: 1px;", "}", ".blocklyIconSymbol {",
	"fill: #fff;", "}", ".blocklyMinimalBody {", "margin: 0;", "padding: 0;", "}", ".blocklyCommentForeignObject {",
	"position: relative;", "z-index: 0;", "}", ".blocklyCommentRect {", "fill: #E7DE8E;",
	"stroke: #bcA903;", "stroke-width: 1px", "}", ".blocklyCommentTarget {", "fill: transparent;", "stroke: #bcA903;",
	...
	"stroke-width: 3px;", "}", ".blocklyCommentTextarea {", "background-color: #fef49c;", "border: 0;",
	"outline: 0;", "margin: 0;", "padding: 3px;", "resize: none;", "display: block;", "overflow: hidden;", "}",
	".blocklyCommentDeleteIcon {", "cursor: pointer;", "fill: #000;", "display: none", "}",
	".blocklySelected > .blocklyCommentDeleteIcon {", "display: block", "}", ".blocklyDeleteIconShape {", "fill: #000;",
	"stroke: #000;", "stroke-width: 1px;", "}", ".blocklyDeleteIconShape.blocklyDeleteIconHighlighted {", "stroke: #fc3;",
	"}", ".blocklyHtmlInput {", "border: none;", "border-radius: 4px;", "font-family: sans-serif;",
	...
	".blocklyTransparentBackground {", "opacity: 0;", "}", ".blocklyMainWorkspaceScrollbar {", "z-index: 20;", "}",
	...
	".blocklyScrollbarHandle {", "fill: #ccc;", "}", ".blocklyScrollbarBackground:hover+.blocklyScrollbarHandle,",
	".blocklyScrollbarHandle:hover {", "fill: #bbb;", "}", ".blocklyZoom>image, .blocklyZoom>svg>image {", "opacity: .4;",
	...
	"fill: #bbb;", "}", ".blocklyFlyout .blocklyScrollbarBackground:hover+.blocklyScrollbarHandle,",
	...
	"pointer-events: none;", "}", ".blocklyContextMenu {", "border-radius: 4px;", "max-height: 100%;", "}",
	".blocklyDropdownMenu {", "padding: 0 !important;", "}",
	".blocklyWidgetDiv .goog-option-selected .goog-menuitem-checkbox,",
	".blocklyWidgetDiv .goog-option-selected .goog-menuitem-icon {",
	"background: url('@/assets/images/sprites.png') no-repeat -48px -16px;", "}", ".blocklyToolboxDiv {",
	"background-color: #ddd;", "overflow-x: visible;", "overflow-y: auto;", "position: absolute;", "user-select: none;",
	"-moz-user-select: none;",
	"-ms-user-select: none;", "-webkit-user-select: none;", "z-index: 70;", "-webkit-tap-highlight-color: transparent;",
	"}", ".blocklyTreeRoot {", "padding: 4px 0;", "}", ".blocklyTreeRoot:focus {", "outline: none;", "}",
	".blocklyTreeRow {", "height: 22px;", "line-height: 22px;", "margin-bottom: 3px;", "padding-right: 8px;",
	"white-space: nowrap;", "}", ".blocklyHorizontalTree {", "float: left;", "margin: 1px 5px 8px 0;", "}",
	...
	"margin: 0 5px;", "}", ".blocklyTreeIcon {", "background-image: url('@/assets/images/sprites.png');", "height: 16px;",
	...
	"border: 1px solid #666;", "padding: 0;", "}", ".blocklyColourTable>tr>td>div {", "border: 1px solid #666;",
	"height: 13px;",
	"width: 15px;", "}", ".blocklyColourTable>tr>td>div:hover {", "border: 1px solid #fff;", "}",
	...
	"z-index: 20000;", "}", ".blocklyDropDownDiv .goog-menu {", "cursor: default;",
	'font: normal 13px "Helvetica Neue", Helvetica, sans-serif;', "outline: none;", "z-index: 20000;", "}",
	".blocklyWidgetDiv .goog-menuitem, ", ".blocklyDropDownDiv .goog-menuitem {", "color: #000;",
	"font: normal 13px Arial, sans-serif;", "list-style: none;", "margin: 0;", "min-width: 7em;",
	"padding: 5px 5px 5px 28px;", "white-space: nowrap;", "}", ".blocklyWidgetDiv .goog-menuitem.goog-menuitem-rtl, ",
	".blocklyDropDownDiv .goog-menuitem.goog-menuitem-rtl {",
	"padding-left: 5px;", "padding-right: 28px;", "}", ".blocklyWidgetDiv .goog-menu-nocheckbox .goog-menuitem, ",
	".blocklyWidgetDiv .goog-menu-noicon .goog-menuitem, ", ".blocklyDropDownDiv .goog-menu-nocheckbox .goog-menuitem, ",
	".blocklyDropDownDiv .goog-menu-noicon .goog-menuitem { ", "padding-left: 12px;", "}",
	".blocklyWidgetDiv .goog-menu-noaccel .goog-menuitem, ", ".blocklyDropDownDiv .goog-menu-noaccel .goog-menuitem {",
	"padding-right: 20px;", "}", ".blocklyWidgetDiv .goog-menuitem-content, ",
	".blocklyDropDownDiv .goog-menuitem-content {",
	"color: #000;", "font: normal 13px Arial, sans-serif;", "}",
	".blocklyWidgetDiv .goog-menuitem-disabled .goog-menuitem-accel, ",
	".blocklyWidgetDiv .goog-menuitem-disabled .goog-menuitem-content, ",
	".blocklyDropDownDiv .goog-menuitem-disabled .goog-menuitem-accel, ",
	".blocklyDropDownDiv .goog-menuitem-disabled .goog-menuitem-content {", "color: #ccc !important;", "}",
	...
	"border-style: dotted;", "border-width: 1px 0;", "padding-bottom: 4px;", "padding-top: 4px;", "}",
	".blocklyDropDownDiv .goog-menuitem-highlight, ", ".blocklyDropDownDiv .goog-menuitem-hover {",
	"background-color: rgba(0, 0, 0, 0.2);", "}", ".blocklyWidgetDiv .goog-menuitem-checkbox, ",
	".blocklyWidgetDiv .goog-menuitem-icon, ", ".blocklyDropDownDiv .goog-menuitem-checkbox, ",
	".blocklyDropDownDiv .goog-menuitem-icon {", "background-repeat: no-repeat;", "height: 16px;", "left: 6px;",
	...
	"float: right;", "margin-right: -24px;", "}", ".blocklyWidgetDiv .goog-menuitem-accel, ",
	".blocklyDropDownDiv .goog-menuitem-accel {", "color: #999;", "direction: ltr;", "left: auto;", "padding: 0 6px;",
	"position: absolute;", "right: 0;", "text-align: right;", "}",
	".blocklyWidgetDiv .goog-menuitem-rtl .goog-menuitem-accel, ",
	".blocklyDropDownDiv .goog-menuitem-rtl .goog-menuitem-accel {", "left: 0;", "right: auto;", "text-align: left;", "}",
	".blocklyWidgetDiv .goog-menuitem-mnemonic-hint, ", ".blocklyDropDownDiv .goog-menuitem-mnemonic-hint {",
	"text-decoration: underline;", "}", ".blocklyWidgetDiv .goog-menuitem-mnemonic-separator, ",
	".blocklyDropDownDiv .goog-menuitem-mnemonic-separator {", "color: #999;", "font-size: 12px;", "padding-left: 4px;",
	"}", ".blocklyWidgetDiv .goog-menuseparator, ", ".blocklyDropDownDiv .goog-menuseparator {",
...
Blockly.createMainWorkspace_ = function(a, b, c, d) {
	...
	b.readOnly || e.isMovable() || e.addChangeListener(function(a) {
		if (!e.isDragging() && !e.isMovable() &&
			...
			e.isContentBounded() ? (c = e.getBlocksBoundingBox(), b.contentLeft = c.left, b.contentTop = c.top, b.contentRight =
				c.right, b.contentBottom = c.bottom) : (b.contentLeft = c.contentLeft / d, b.contentTop = c.contentTop / d, b.contentRight =
				(c.contentLeft + c.contentWidth) / d, b.contentBottom = (c.contentTop +
					c.contentHeight) / d);
			if (b.contentTop < b.viewTop || b.contentBottom > b.viewBottom || b.contentLeft < b.viewLeft || b.contentRight >
				...
				a && (a.group || console.log(
					"WARNING: Moved object in bounds but there was no event group. This may break undo."), Blockly.Events.setGroup(
					c))
			}
		}
	});
...
Blockly.inject.bindDocumentEvents_ = function() {
	Blockly.documentEventsBound_ || (Blockly.bindEventWithChecks_(document, "scroll", null, function() {
		...
		}), Blockly.bindEventWithChecks_(document, "keydown", null, Blockly.onKeyDown_), Blockly.bindEvent_(document,
	...
	if (!(b.options.readOnly || Blockly.utils.isTargetInput(a) || b.rendered && !b.isVisible())) {
		...
		if (27 == a.keyCode) Blockly.hideChaff();
			...
			Blockly.selected && Blockly.selected.isDeletable() && Blockly.selected.isMovable() &&
				(67 == a.keyCode ? (Blockly.hideChaff(), Blockly.copy_(Blockly.selected)) : 88 != a.keyCode || Blockly.selected.workspace
					.isFlyout || (Blockly.copy_(Blockly.selected), c = !0));
			86 == a.keyCode ? Blockly.clipboardXml_ && (a = Blockly.clipboardSource_, a.isFlyout && (a = a.targetWorkspace),
				Blockly.clipboardTypeCounts_ && a.isCapacityAvailable(Blockly.clipboardTypeCounts_) && (Blockly.Events.setGroup(!
					0), a.paste(Blockly.clipboardXml_), Blockly.Events.setGroup(!1))) : 90 == a.keyCode && (Blockly.hideChaff(), b.undo(
				a.shiftKey))
		}
...
Blockly.refreshTheme_ = function(a) {
	...
	!a.toolbox_ && a.flyout_ && a.flyout_.workspace_ ? Blockly.updateBlockStyles_(a.flyout_.workspace_.getAllBlocks()) :
