...
// 平台分配编辑人员保存
const PRODUCT_PLATFORM_OPERATION_BATCH_UPDATE = {
  method: 'post',
  url: '/product/platform/operation/batch/update'
}
...
// 获取所有图片的压缩包
const PRODUCT_IMAGE_DOWNLOAD_ALL_ZIP = {
  method: 'post',
  url: '/product/image/download/all/zip'
}

// 作废产品
const PRODUCT_PLATFORM_INVALID = {
  method: 'post',
  url: '/product/platform/invalid'
}

// 作废还原产品
const PRODUCT_PLATFORM_INVALID_BACK = {
  method: 'post',
  url: '/product/platform/invalid/back'
}

// 删除产品
const PRODUCT_PLATFORM_REMOVE = {
  method: 'post',
  url: '/product/platform/remove'
}

// 类目产品数量
const PRODUCT_PLATFORM_CATEGORY_NUM = {
  method: 'post',
  url: '/product/platform/category/num'
}

// 平台编辑保存类目信息
const PRODUCT_PLT_DETAIL_CATEGORY_UPDATE = {
  method: 'post',
  url: '/product/plt/detail/category/update'
}

// 【平台产品图片】根据母体id获取变体列表
const PRODUCT_IMAGE_LIST_VARIANTS = {
  method: 'post',
  url: '/product/image/list/variants'
}

// 【平台产品图片】上传图片
const PRODUCT_IMAGE_UPLOAD_IMAGE = {
  method: 'post',
  url: '/product/image/upload/image'
}

// 【平台产品图片】根据变体id获取图片
const PRODUCT_IMAGE_LIST_IMG = {
  method: 'post',
  url: '/product/image/list/img'
}
...
//  平台产品作废 productPlatformIds    platformId
const PRODUCT_PLATFORM_BATCH_INVALID = {
  method: 'post',
  url: '/product/platform/batch/invalid'
}

//  平台批量删除 productPlatformIds     platformId
const PRODUCT_PLATFORM_BATCH_REMOVE = {
  method: 'post',
  url: '/product/platform/batch/remove'
}

//  平台语种获取  productPltDetailId    type  1平台信息编辑获取 2.平台信息审核获取
const PRODUCT_PLT_DETAIL_LANGUAGE_LIST = {
  method: 'post',
  url: '/product/plt/detail/language/list'
}

//  获取ebay平台信息编辑下拉数据
const saleEbayProItemSaleEbayProItem = {
  method: 'post',
  url: '/SaleEbayProItem/SaleEbayProItem'
}

module.exports = {
  GET_ERP_PLATFORM_LISTS,
  PRODUCT_PLATFORM_BATCH_REMOVE,
  PRODUCT_PLT_DETAIL_LANGUAGE_LIST,
  PRODUCT_PLATFORM_BATCH_INVALID,
  PRODUCT_IMAGE_UPLOAD_IMAGE,
  PRODUCT_IMAGE_IMG_DELETE,
  PRODUCT_IMAGE_LIST_IMG,
  PRODUCT_IMAGE_LIST_VARIANTS,
  PRODUCT_IMAGE_DOWNLOAD_ALL_ZIP,
  PRODUCT_PLATFORM_CATEGORY_NUM,
  PRODUCT_PLT_DETAIL_CATEGORY_UPDATE,
  PRODUCT_PLATFORM_REMOVE,
  PRODUCT_PLATFORM_INVALID_BACK,
  PRODUCT_PLATFORM_INVALID,
  ...
  PRODUCT_PLATFORM_OPERATION_BATCH_UPDATE,
  ...
  PUTAWAY_COMMIT,
  saleEbayProItemSaleEbayProItem,
