              ...
              <v-row :gutter="16">
                ...
                <v-col :xs="12" :lg="16" :md="16">
                  ...
                  <v-card title="销售单品排名" :loading="loading">
                    <div ref="main1" style="width: 100%;height:400px;"></div>
                  </v-card>
                </v-col>
              </v-row>
            </div>
...
import { fetchAllData, echartsCommonConfig } from "common/common";
import { GET_ADMIN_CHARTS, GET_ADMIN_CARD, GET_MAIN_MENU } from "apis";
...
export default {
  ...
  mounted() {
    ...
    setTimeout(() => {
      ...
      //     this.cards = res[0].data.rows;
      //     this.mainMenu = res[2].data.rows;
      //     return res[1]
      //   });
      let data = [
        {
